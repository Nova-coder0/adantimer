...
if ($RunLive) {
  ...
  TestLiveUrl "$BaseUrl/fr/prayer-times" @('<html lang="fr" dir="ltr">', 'href="/fr/alger"', 'href="/fr/oran"', 'href="/fr/annaba"', 'href="/fr/bouira"', 'href="/fr/ain-benian"', 'horaire priere', 'adhan aujourd')
  ...
  TestLiveUrl "$BaseUrl/ar/prayer-times" @('<html lang="ar" dir="rtl">', 'href="/ar/alger"', 'href="/ar/oran"', 'href="/ar/annaba"', 'href="/ar/bouira"', 'href="/ar/ain-benian"')
...
TestLiveUrlRegex "$BaseUrl/chesham" @('<title>Prayer Times in Chesham Today \| Fajr, Dhuhr, Asr, Maghrib &(?:amp;|) Isha \| Adantimer</title>')
  TestLiveUrl "$BaseUrl/fr/oran" @('<html lang="fr" dir="ltr">', '<body data-page="home">', 'Horaires de prière à Oran aujourd', 'horaire priere', 'heure dohr', 'maghreb', 'href="/fr/alger"', 'href="/fr/annaba"', 'href="/fr/bouira"', 'href="/fr/ain-benian"')
  ...
  TestLiveUrl "$BaseUrl/ar/oran" @('<html lang="ar" dir="rtl">', '<body data-page="home">', 'الصلاة القادمة', 'وقت الفجر', 'href="/ar/alger"', 'href="/ar/annaba"', 'href="/ar/bouira"', 'href="/ar/ain-benian"')
