...
AssertContains $renderJs 'Object.assign(copy, buildEnglishPriorityHomeCityCopy("Dubai", "dubai"));' "SSR renderer routes Dubai through the shared English priority builder" "SSR renderer no longer routes Dubai through the shared English priority builder"
AssertContains $renderJs 'Object.assign(copy, buildEnglishPriorityHomeCityCopy("Mecca", "mecca"));' "SSR renderer routes Mecca through the shared English priority builder" "SSR renderer no longer routes Mecca through the shared English priority builder"
AssertContains $renderJs 'Object.assign(copy, buildEnglishPriorityHomeCityCopy(cityName));' "SSR renderer routes generic English priority cities through the shared builder" "SSR renderer no longer routes generic English priority cities through the shared builder"
...
AssertContains $renderJs 'if (language === "ar" && pageType === "home" && cityKey === "dubai")' "SSR renderer keeps the Arabic Dubai priority city switch" "SSR renderer is missing the Arabic Dubai priority city switch"
AssertContains $renderJs 'Object.assign(copy, buildArabicPriorityHomeCityCopy(cityName));' "SSR renderer routes generic Arabic priority cities through the shared home-city builder" "SSR renderer no longer routes generic Arabic priority cities through the shared home-city builder"
