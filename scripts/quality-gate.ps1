...
if ($RunLive) {
  ...
  TestLiveUrl "$BaseUrl/prayer-times" @('href="/oran"', 'href="/annaba"', 'href="/chesham"')
  TestLiveUrl "$BaseUrl/fr/prayer-times" @('<html lang="fr" dir="ltr">', 'href="/fr/oran"', 'href="/fr/annaba"')
  TestLiveUrl "$BaseUrl/ar/prayer-times" @('<html lang="ar" dir="rtl">', 'href="/ar/oran"', 'href="/ar/annaba"')
