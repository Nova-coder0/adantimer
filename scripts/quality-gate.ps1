...
if ($RunLive) {
  ...
  TestLiveUrl "$BaseUrl/prayer-times" @('href="/oran"', 'href="/annaba"', 'href="/bouira"', 'href="/chesham"')
  TestLiveUrl "$BaseUrl/fr/prayer-times" @('<html lang="fr" dir="ltr">', 'href="/fr/oran"', 'href="/fr/annaba"', 'href="/fr/bouira"')
  TestLiveUrl "$BaseUrl/ar/prayer-times" @('<html lang="ar" dir="rtl">', 'href="/ar/oran"', 'href="/ar/annaba"', 'href="/ar/bouira"')
