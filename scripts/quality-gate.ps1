...
AssertContains $renderJs 'Object.assign(copy, priorityHomeCityCopy);' "SSR renderer applies resolved priority home-city copy in one place" "SSR renderer no longer applies resolved priority home-city copy in one place"
...
TestLiveUrlRegex "$BaseUrl/chesham" @('<title>Prayer Times in Chesham Today \| Fajr, Dhuhr, Asr, Maghrib &(?:amp;|) Isha \| Adantimer</title>')
  TestLiveUrl "$BaseUrl/fr/oran" @('<html lang="fr" dir="ltr">', '<body data-page="home">', 'Horaires de prière à Oran aujourd', 'horaire priere', 'heure dohr', 'maghreb', 'href="/fr/next-prayer/oran"', 'href="/fr/fajr-time/oran"', 'href="/fr/alger"', 'href="/fr/constantine"', 'href="/fr/setif"', 'href="/fr/annaba"', 'href="/fr/bouira"', 'href="/fr/ain-benian"')
  ...
  TestLiveUrl "$BaseUrl/ar/oran" @('<html lang="ar" dir="rtl">', '<body data-page="home">', 'الصلاة القادمة', 'وقت الفجر', 'href="/ar/next-prayer/oran"', 'href="/ar/fajr-time/oran"', 'href="/ar/alger"', 'href="/ar/constantine"', 'href="/ar/setif"', 'href="/ar/annaba"', 'href="/ar/bouira"', 'href="/ar/ain-benian"')
