...
AssertContains $renderJs '["annaba", { cityName: "عنابة", variant: "generic" }]' "SSR renderer registers Annaba as an Arabic GSC winner home-city variant" "SSR renderer is missing the Arabic Annaba GSC winner variant"
AssertContains $renderJs '["bouira", { cityName: "البويرة", variant: "generic" }]' "SSR renderer registers Bouira as an Arabic GSC winner home-city variant" "SSR renderer is missing the Arabic Bouira GSC winner variant"
AssertContains $renderJs '["ain-benian", { cityName: "عين البنيان", variant: "generic" }]' "SSR renderer registers Ain Benian as an Arabic GSC winner home-city variant" "SSR renderer is missing the Arabic Ain Benian GSC winner variant"
...
TestLiveUrl "$BaseUrl/ar/annaba" @('<html lang="ar" dir="rtl">', '<body data-page="home">')
...
TestLiveUrl "$BaseUrl/ar/bouira" @('<html lang="ar" dir="rtl">', '<body data-page="home">')
...
TestLiveUrl "$BaseUrl/ar/ain-benian" @('<html lang="ar" dir="rtl">', '<body data-page="home">')
