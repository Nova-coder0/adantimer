...
if ($RunLive) {
  ...
  TestLiveUrl "$BaseUrl/fr/prayer-times" @('<html lang="fr" dir="ltr">', 'href="/fr/oran"', 'href="/fr/annaba"', 'href="/fr/bouira"', 'href="/fr/ain-benian"', 'horaire priere', 'adhan aujourd&#39;hui')
...
TestLiveUrlRegex "$BaseUrl/chesham" @('<title>Prayer Times in Chesham Today \| Fajr, Dhuhr, Asr, Maghrib &(?:amp;|) Isha \| Adantimer</title>')
  TestLiveUrl "$BaseUrl/fr/oran" @('<html lang="fr" dir="ltr">', '<body data-page="home">', 'Horaires de prière à Oran aujourd', 'horaire priere', 'heure dohr', 'icha aujourd&#39;hui')
...
TestLiveUrl "$BaseUrl/fr/annaba" @('<html lang="fr" dir="ltr">', '<body data-page="home">', 'Horaires de prière à Annaba aujourd')
...
TestLiveUrl "$BaseUrl/fr/bouira" @('<html lang="fr" dir="ltr">', '<body data-page="home">', 'Horaires de prière à Bouira aujourd')
...
TestLiveUrl "$BaseUrl/fr/ain-benian" @('<html lang="fr" dir="ltr">', '<body data-page="home">', 'Horaires de prière à Ain Benian aujourd')
