...
TestLiveUrlRegex "$BaseUrl/chesham" @('<title>Prayer Times in Chesham Today \| Fajr, Dhuhr, Asr, Maghrib &(?:amp;|) Isha \| Adantimer</title>')
  TestLiveUrl "$BaseUrl/fr/oran" @('<html lang="fr" dir="ltr">', '<body data-page="home">', 'Horaires de prière à Oran aujourd', 'horaire priere', 'heure dohr', 'maghreb')
  ...
  TestLiveUrl "$BaseUrl/ar/oran" @('<html lang="ar" dir="rtl">', '<body data-page="home">', 'الصلاة القادمة', 'وقت الفجر')
