...
AssertContains $indexHtml 'data-lang="pt"' "Homepage includes the Portuguese language option" "Homepage is missing the Portuguese language option"
AssertContains $indexHtml 'data-lang="es"' "Homepage includes the Spanish language option" "Homepage is missing the Spanish language option"
AssertContains $indexHtml 'hreflang="pt"' "Homepage template includes the Portuguese alternate tag" "Homepage template is missing the Portuguese alternate tag"
AssertContains $indexHtml 'hreflang="es"' "Homepage template includes the Spanish alternate tag" "Homepage template is missing the Spanish alternate tag"
...
AssertContains $indexHtml '"inLanguage": ["en", "ar", "de", "fr", "pt", "es", "tr", "zh-Hans"]' "Structured data lists the supported languages" "Structured data language list is incomplete"
...
AssertContains $renderJs 'function getAlternates(pageType, city, surahSlug = "", currentLanguage = "en")' "SSR renderer keeps alternate-link generation" "SSR renderer is missing alternate-link generation"
...
AssertContains $renderJs 'const SUPPORTED_RENDER_LANGUAGES = ["en", "ar", "de", "fr", "pt", "es", "tr", "zh-hans"];' "SSR renderer tracks all supported languages" "SSR renderer supported-language list is missing or incomplete"
...
AssertContains $scriptJs '"pt-br": "pt"' "Client aliases support Brazilian Portuguese" "Client aliases are missing Brazilian Portuguese support"
AssertContains $scriptJs '"es-mx": "es"' "Client aliases support Spanish regional variants" "Client aliases are missing Spanish regional variants"
AssertContains $rewritesText '"/pt"' "vercel.json includes Portuguese rewrites" "vercel.json is missing Portuguese rewrites"
AssertContains $rewritesText '"/es"' "vercel.json includes Spanish rewrites" "vercel.json is missing Spanish rewrites"
AssertContains $renderJs 'hreflang="pt"' "SSR renderer updates the Portuguese alternate tag" "SSR renderer is missing the Portuguese alternate replacement"
AssertContains $renderJs 'hreflang="es"' "SSR renderer updates the Spanish alternate tag" "SSR renderer is missing the Spanish alternate replacement"
...
AssertContains $renderJs 'function buildEnglishPriorityIntentCopy(pageType)' "SSR renderer centralizes English priority intent copy in a shared builder" "SSR renderer is missing the shared English priority intent builder"
AssertContains $renderJs 'function buildEnglishPriorityIntentCityCopy(pageType, cityKey, place)' "SSR renderer centralizes small city-intent priority copy in a shared builder" "SSR renderer is missing the shared city-intent priority builder"
AssertContains $renderJs 'function buildArabicPriorityIntentCityCopy(pageType, cityKey, place)' "SSR renderer centralizes Arabic city-intent priority copy in a shared builder" "SSR renderer is missing the shared Arabic city-intent priority builder"
AssertContains $renderJs 'function getPriorityIntentSeoCopy(language, pageType, sourceCity)' "SSR renderer centralizes priority intent dispatch in a shared resolver" "SSR renderer is missing the shared priority intent resolver"
...
AssertContains $renderJs 'return buildEnglishPriorityIntentCopy(pageType);' "SSR renderer routes English prayer-intent pages through the shared builder" "SSR renderer no longer routes English prayer-intent pages through the shared builder"
AssertContains $renderJs 'const priorityIntentCopy = getPriorityIntentSeoCopy(language, pageType, sourceCity);' "SSR renderer resolves priority intent copy through the shared resolver" "SSR renderer is not using the shared priority intent resolver"
AssertContains $renderJs 'Object.assign(copy, priorityIntentCopy);' "SSR renderer applies resolved priority intent copy in one place" "SSR renderer no longer applies resolved priority intent copy in one place"
AssertContains $renderJs 'const priorityIntentCityCopy = language === "en"' "SSR renderer resolves city-intent priority copy before the generic priority path" "SSR renderer is missing the city-intent priority resolver"
...
AssertContains $renderJs '["annaba", { cityName: "Annaba", variant: "generic" }]' "SSR renderer registers Annaba as an English GSC winner home-city variant" "SSR renderer is missing the English Annaba GSC winner variant"
AssertContains $renderJs '["bouira", { cityName: "Bouira", variant: "generic" }]' "SSR renderer registers Bouira as an English GSC winner home-city variant" "SSR renderer is missing the English Bouira GSC winner variant"
AssertContains $renderJs '["ain-benian", { cityName: "Ain Benian", variant: "generic" }]' "SSR renderer registers Ain Benian as an English GSC winner home-city variant" "SSR renderer is missing the English Ain Benian GSC winner variant"
...
AssertContains $renderJs '["annaba", { cityName: "Annaba", variant: "generic" }]' "SSR renderer registers Annaba as a French GSC winner home-city variant" "SSR renderer is missing the French Annaba GSC winner variant"
AssertContains $renderJs '["bouira", { cityName: "Bouira", variant: "generic" }]' "SSR renderer registers Bouira as a French GSC winner home-city variant" "SSR renderer is missing the French Bouira GSC winner variant"
AssertContains $renderJs '["ain-benian", { cityName: "Ain Benian", variant: "generic" }]' "SSR renderer registers Ain Benian as a French GSC winner home-city variant" "SSR renderer is missing the French Ain Benian GSC winner variant"
AssertContains $renderJs 'const ALGERIA_FOCUS_CITIES = [' "SSR renderer defines the broader Algeria focus city pool" "SSR renderer is missing the broader Algeria focus city pool"
AssertContains $renderJs '"Constantine"' "SSR renderer includes Constantine in the Algeria focus city pool" "SSR renderer is missing Constantine in the Algeria focus city pool"
AssertContains $renderJs 'buildAlgeriaPrayerHubLinks("fr")' "French prayer hubs use the expanded Algeria link builder" "French prayer hubs are missing the expanded Algeria link builder"
AssertContains $renderJs 'buildAlgeriaPrayerHubLinks("ar")' "Arabic prayer hubs use the expanded Algeria link builder" "Arabic prayer hubs are missing the expanded Algeria link builder"
...
AssertContains $renderJs '["oran", { cityName: "وهران", variant: "oran" }]' "SSR renderer registers Oran as an Arabic GSC winner home-city variant" "SSR renderer is missing the Arabic Oran GSC winner variant"
AssertContains $renderJs '["annaba", { cityName: "عنابة", variant: "annaba" }]' "SSR renderer registers Annaba as an Arabic GSC winner home-city variant" "SSR renderer is missing the Arabic Annaba GSC winner variant"
AssertContains $renderJs '["bouira", { cityName: "البويرة", variant: "bouira" }]' "SSR renderer registers Bouira as an Arabic GSC winner home-city variant" "SSR renderer is missing the Arabic Bouira GSC winner variant"
AssertContains $renderJs '["ain-benian", { cityName: "عين البنيان", variant: "ain-benian" }]' "SSR renderer registers Ain Benian as an Arabic GSC winner home-city variant" "SSR renderer is missing the Arabic Ain Benian GSC winner variant"
...
AssertContains $renderJs 'cityIntentLinks: buildAlgeriaGenericIntentLinks("ar", pageType)' "SSR renderer routes Arabic prayer-intent pages through the Algeria intent-link builder" "SSR renderer is missing the Arabic Algeria intent-link builder wiring"
...
AssertContains $renderJs 'function getPriorityHomeCitySeoCopy(language, pageType, cityKey, place)' "SSR renderer centralizes priority home-city dispatch in a shared resolver" "SSR renderer is missing the shared priority home-city resolver"
AssertContains $renderJs 'const PRIORITY_HOME_CUSTOM_VARIANTS = {' "SSR renderer centralizes priority home-city custom variants" "SSR renderer is missing the shared priority home-city custom variants"
AssertContains $renderJs 'const ENGLISH_PRIORITY_HOME_GENERIC_SLUGS = getPriorityHomeGenericSlugs(ENGLISH_PRIORITY_HOME_CITIES, "en");' "SSR renderer derives the second English priority city switch from shared variants" "SSR renderer is missing the derived second English priority city switch"
AssertContains $renderJs 'const customVariant = PRIORITY_HOME_CUSTOM_VARIANTS.en.get(cityKey);' "SSR renderer routes English custom home-city variants through shared config" "SSR renderer is missing the English custom home-city variant lookup"
AssertContains $renderJs 'return buildEnglishPriorityHomeCityCopy(cityName);' "SSR renderer routes generic English priority cities through the shared builder" "SSR renderer no longer routes generic English priority cities through the shared builder"
AssertContains $renderJs 'const priorityHomeCityCopy = getPriorityHomeCitySeoCopy(language, pageType, cityKey, place);' "SSR renderer resolves priority home-city copy through the shared resolver" "SSR renderer is not using the shared priority home-city resolver"
AssertContains $renderJs 'Object.assign(copy, applyAlgeriaKeywordCoverageEnhancements(language, pageType, cityKey, place, priorityHomeCityCopy));' "SSR renderer applies resolved priority home-city copy through the Algeria keyword enhancer" "SSR renderer no longer applies resolved priority home-city copy through the Algeria keyword enhancer"
...
AssertContains $renderJs 'const ARABIC_PRIORITY_HOME_GENERIC_SLUGS = getPriorityHomeGenericSlugs(ARABIC_PRIORITY_HOME_CITIES, "ar");' "SSR renderer derives the Arabic core priority city switch from shared variants" "SSR renderer is missing the derived Arabic core priority city switch"
AssertContains $renderJs 'const ARABIC_PRIORITY_HOME_CITY_BY_SLUG = new Map(' "SSR renderer derives the Arabic priority city map from central config" "SSR renderer is missing the derived Arabic priority city map"
AssertContains $renderJs 'function buildArabicPriorityHomeCityCopy(cityName, variant = "generic")' "SSR renderer centralizes Arabic priority home-city copy in a shared builder" "SSR renderer is missing the shared Arabic priority home-city builder"
AssertContains $renderJs 'const customVariant = PRIORITY_HOME_CUSTOM_VARIANTS.ar.get(cityKey);' "SSR renderer routes Arabic custom home-city variants through shared config" "SSR renderer is missing the Arabic custom home-city variant lookup"
AssertContains $renderJs 'return buildArabicPriorityHomeCityCopy(cityName);' "SSR renderer routes generic Arabic priority cities through the shared home-city builder" "SSR renderer no longer routes generic Arabic priority cities through the shared home-city builder"
AssertContains $renderJs 'localizeCityName(ARABIC_PRIORITY_HOME_CITY_BY_SLUG.get(cityKey)?.city || place, "ar")' "SSR renderer derives Arabic priority city names from the central map" "SSR renderer is still hardcoding Arabic priority city names inline"
...
AssertContains $sitemapCore 'https://www.adantimer.com/pt' "Core sitemap includes the Portuguese homepage" "Core sitemap is missing the Portuguese homepage"
AssertContains $sitemapCore 'https://www.adantimer.com/es' "Core sitemap includes the Spanish homepage" "Core sitemap is missing the Spanish homepage"
...
AssertContains $sitemapGscWinners 'https://www.adantimer.com/ar/annaba' "GSC-winners sitemap includes Arabic Annaba" "GSC-winners sitemap is missing Arabic Annaba"
AssertContains $sitemapGscWinners 'https://www.adantimer.com/fr/bouira' "GSC-winners sitemap includes French Bouira" "GSC-winners sitemap is missing French Bouira"
AssertContains $sitemapGscWinners 'https://www.adantimer.com/ar/bouira' "GSC-winners sitemap includes Arabic Bouira" "GSC-winners sitemap is missing Arabic Bouira"
AssertContains $sitemapGscWinners 'https://www.adantimer.com/fr/ain-benian' "GSC-winners sitemap includes French Ain Benian" "GSC-winners sitemap is missing French Ain Benian"
AssertContains $sitemapGscWinners 'https://www.adantimer.com/ar/ain-benian' "GSC-winners sitemap includes Arabic Ain Benian" "GSC-winners sitemap is missing Arabic Ain Benian"
AssertNotContains $sitemapGscWinners 'https://www.adantimer.com/oran' "GSC-winners sitemap no longer prioritizes English Oran" "GSC-winners sitemap still prioritizes English Oran"
AssertContains $sitemapGscWinners 'https://www.adantimer.com/chesham' "GSC-winners sitemap includes Chesham" "GSC-winners sitemap is missing Chesham"
...
if ($RunLive) {
  ...
  TestLiveUrl "$BaseUrl/de/prayer-times" @('<html lang="de" dir="ltr">', 'href="/de/berlin"', 'href="/de/cologne"', 'Gebetszeiten heute', 'Salat Zeiten', 'Adhan Zeit')
  TestLiveUrlRegex "$BaseUrl/de/prayer-times" @('<title>Gebetszeiten heute \| Salat Zeiten, Namaz Zeiten und Adhan Zeit \| Adantimer</title>')
  TestLiveUrl "$BaseUrl/de/next-prayer" @('<html lang="de" dir="ltr">', 'href="/de/next-prayer/berlin"', 'href="/de/next-prayer/cologne"', 'Azan Zeit')
  TestLiveUrlRegex "$BaseUrl/de/next-prayer" @('<title>Naechste Gebetszeit heute \| Live Countdown fuer Adhan und Azan Zeit \| Adantimer</title>')
  TestLiveUrl "$BaseUrl/de/fajr-time" @('<html lang="de" dir="ltr">', 'href="/de/fajr-time/berlin"', 'href="/de/fajr-time/frankfurt"', 'Fadschr Zeit')
  TestLiveUrlRegex "$BaseUrl/de/fajr-time" @('<title>Fajr Zeit heute \| Fadschr Zeit und Fajr Gebetszeit \| Adantimer</title>')
  TestLiveUrl "$BaseUrl/de/maghrib-time" @('<html lang="de" dir="ltr">', 'href="/de/maghrib-time/cologne"', 'href="/de/maghrib-time/hamburg"', 'Maghrib Zeit')
  TestLiveUrlRegex "$BaseUrl/de/maghrib-time" @('<title>Maghrib Zeit heute \| Abendgebet und Maghrib Gebetszeit \| Adantimer</title>')
  ...
  TestLiveUrl "$BaseUrl/ar/prayer-times/mecca" @('<html lang="ar" dir="rtl">', '<body data-page="prayer-times">')
  TestLiveUrlRegex "$BaseUrl/ar/prayer-times/mecca" @('<title>\u0645\u0648\u0627\u0642\u064a\u062a \u0627\u0644\u0635\u0644\u0627\u0629 \u0641\u064a \u0645\u0643\u0629 \u0627\u0644\u064a\u0648\u0645 \| \u0627\u0644\u0641\u062c\u0631 \u0648\u0627\u0644\u0638\u0647\u0631 \u0648\u0627\u0644\u0639\u0635\u0631 \u0648\u0627\u0644\u0645\u063a\u0631\u0628 \u0648\u0627\u0644\u0639\u0634\u0627\u0621 \| Adantimer</title>', '\u0643\u064a\u0641 \u062a\u0633\u062a\u062e\u062f\u0645 \u0635\u0641\u062d\u0629 \u0645\u0648\u0627\u0642\u064a\u062a \u0627\u0644\u0635\u0644\u0627\u0629 \u0641\u064a \u0645\u0643\u0629')
  TestLiveUrl "$BaseUrl/ar/next-prayer/riyadh" @('<html lang="ar" dir="rtl">', '<body data-page="next-prayer">')
  TestLiveUrlRegex "$BaseUrl/ar/next-prayer/riyadh" @('<title>\u0627\u0644\u0635\u0644\u0627\u0629 \u0627\u0644\u0642\u0627\u062f\u0645\u0629 \u0641\u064a \u0627\u0644\u0631\u064a\u0627\u0636 \u0627\u0644\u064a\u0648\u0645 \| \u0639\u062f \u062a\u0646\u0627\u0632\u0644\u064a \u0645\u0628\u0627\u0634\u0631 \u0644\u0644\u0635\u0644\u0627\u0629 \| Adantimer</title>', '\u0645\u0627 \u0627\u0644\u0630\u064a \u064a\u062c\u0628 \u0623\u0646 \u062a\u062c\u064a\u0628 \u0639\u0646\u0647 \u0635\u0641\u062d\u0629 \u0627\u0644\u0635\u0644\u0627\u0629 \u0627\u0644\u0642\u0627\u062f\u0645\u0629 \u0641\u064a \u0627\u0644\u0631\u064a\u0627\u0636 \u0623\u0648\u0644\u0627')
  TestLiveUrl "$BaseUrl/ar/fajr-time/medina" @('<html lang="ar" dir="rtl">', '<body data-page="fajr">')
  ...
  TestLiveUrl "$BaseUrl/ar/next-prayer/oran" @('<html lang="ar" dir="rtl">', '<body data-page="next-prayer">', 'الصلاة القادمة', 'وهران')
  TestLiveUrlRegex "$BaseUrl/ar/next-prayer/oran" @('<title>\u0627\u0644\u0635\u0644\u0627\u0629 \u0627\u0644\u0642\u0627\u062f\u0645\u0629 \u0641\u064a \u0648\u0647\u0631\u0627\u0646 \u0627\u0644\u064a\u0648\u0645 \| \u0639\u062f \u062a\u0646\u0627\u0632\u0644\u064a \u0645\u0628\u0627\u0634\u0631 \u0644\u0644\u0635\u0644\u0627\u0629 \| Adantimer</title>', '\u0627\u0633\u062a\u062e\u062f\u0645 \u0647\u0630\u0647 \u0627\u0644\u0635\u0641\u062d\u0629 \u0639\u0646\u062f\u0645\u0627 \u062a\u0643\u0648\u0646 \u0627\u0644\u0635\u0644\u0627\u0629 \u0627\u0644\u0642\u0627\u062f\u0645\u0629 \u0641\u064a \u0648\u0647\u0631\u0627\u0646 \u0647\u064a \u0627\u0644\u0633\u0624\u0627\u0644 \u0627\u0644\u0631\u0626\u064a\u0633\u064a')
  TestLiveUrl "$BaseUrl/ar/maghrib-time/annaba" @('<html lang="ar" dir="rtl">', '<body data-page="maghrib">', 'وقت المغرب', 'عنابة')
  TestLiveUrlRegex "$BaseUrl/ar/maghrib-time/annaba" @('<title>\u0648\u0642\u062a \u0627\u0644\u0645\u063a\u0631\u0628 \u0641\u064a \u0639\u0646\u0627\u0628\u0629 \u0627\u0644\u064a\u0648\u0645 \| \u062f\u0644\u064a\u0644 \u0648\u0642\u062a \u0627\u0644\u0645\u063a\u0631\u0628 \u0627\u0644\u064a\u0648\u0645\u064a \| Adantimer</title>', '\u0627\u0633\u062a\u062e\u062f\u0645 \u0647\u0630\u0647 \u0627\u0644\u0635\u0641\u062d\u0629 \u0639\u0646\u062f\u0645\u0627 \u064a\u0643\u0648\u0646 \u0648\u0642\u062a \u0627\u0644\u0645\u063a\u0631\u0628 \u0641\u064a \u0639\u0646\u0627\u0628\u0629 \u0647\u0648 \u0627\u0644\u0633\u0624\u0627\u0644 \u0627\u0644\u0631\u0626\u064a\u0633\u064a')
  TestLiveUrl "$BaseUrl/ar/maghrib-time/bouira" @('<html lang="ar" dir="rtl">', '<body data-page="maghrib">', 'وقت المغرب', 'البويرة')
  TestLiveUrlRegex "$BaseUrl/ar/maghrib-time/bouira" @('<title>\u0648\u0642\u062a \u0627\u0644\u0645\u063a\u0631\u0628 \u0641\u064a \u0627\u0644\u0628\u0648\u064a\u0631\u0629 \u0627\u0644\u064a\u0648\u0645 \| \u062f\u0644\u064a\u0644 \u0648\u0642\u062a \u0627\u0644\u0645\u063a\u0631\u0628 \u0627\u0644\u064a\u0648\u0645\u064a \| Adantimer</title>', '\u0627\u0633\u062a\u062e\u062f\u0645 \u0647\u0630\u0647 \u0627\u0644\u0635\u0641\u062d\u0629 \u0639\u0646\u062f\u0645\u0627 \u064a\u0643\u0648\u0646 \u0648\u0642\u062a \u0627\u0644\u0645\u063a\u0631\u0628 \u0641\u064a \u0627\u0644\u0628\u0648\u064a\u0631\u0629 \u0647\u0648 \u0627\u0644\u0633\u0624\u0627\u0644 \u0627\u0644\u0631\u0626\u064a\u0633\u064a')
  TestLiveUrl "$BaseUrl/ar/isha-time/ain-benian" @('<html lang="ar" dir="rtl">', '<body data-page="isha">', 'وقت العشاء', 'عين البنيان')
  TestLiveUrlRegex "$BaseUrl/ar/isha-time/ain-benian" @('<title>\u0648\u0642\u062a \u0627\u0644\u0639\u0634\u0627\u0621 \u0641\u064a \u0639\u064a\u0646 \u0627\u0644\u0628\u0646\u064a\u0627\u0646 \u0627\u0644\u064a\u0648\u0645 \| \u062f\u0644\u064a\u0644 \u0648\u0642\u062a \u0627\u0644\u0639\u0634\u0627\u0621 \u0627\u0644\u064a\u0648\u0645\u064a \| Adantimer</title>', '\u0627\u0633\u062a\u062e\u062f\u0645 \u0647\u0630\u0647 \u0627\u0644\u0635\u0641\u062d\u0629 \u0639\u0646\u062f\u0645\u0627 \u064a\u0643\u0648\u0646 \u0648\u0642\u062a \u0627\u0644\u0639\u0634\u0627\u0621 \u0641\u064a \u0639\u064a\u0646 \u0627\u0644\u0628\u0646\u064a\u0627\u0646 \u0647\u0648 \u0627\u0644\u0633\u0624\u0627\u0644 \u0627\u0644\u0631\u0626\u064a\u0633\u064a')
  ...
  TestLiveUrl "$BaseUrl/fr/prayer-times" @('<html lang="fr" dir="ltr">', 'href="/fr/alger"', 'href="/fr/oran"', 'href="/fr/constantine"', 'href="/fr/setif"', 'href="/fr/annaba"', 'href="/fr/bouira"', 'href="/fr/ain-benian"', 'horaire priere', 'adhan aujourd', "variantes locales d'Algérie")
  TestLiveUrl "$BaseUrl/fr/next-prayer" @('<html lang="fr" dir="ltr">', 'href="/fr/next-prayer/alger"', 'href="/fr/next-prayer/oran"', 'href="/fr/next-prayer/tlemcen"', 'href="/fr/next-prayer/sidi-bel-abbes"', 'Prochaine prière aujourd', 'adhan aujourd', "variantes locales d'Algérie")
  TestLiveUrlRegex "$BaseUrl/fr/next-prayer" @("<title>Prochaine prière aujourd(?:&#39;|'|’)hui \| Compte à rebours en direct \| Adantimer</title>")
  TestLiveUrl "$BaseUrl/fr/fajr-time" @('<html lang="fr" dir="ltr">', 'href="/fr/fajr-time/alger"', 'href="/fr/fajr-time/oran"', 'href="/fr/fajr-time/batna"', 'href="/fr/fajr-time/setif"', 'Heure du Fajr aujourd', 'heure du fajr')
  TestLiveUrlRegex "$BaseUrl/fr/fajr-time" @("<title>Heure du Fajr aujourd(?:&#39;|'|’)hui \| Recherche quotidienne du Fajr \| Adantimer</title>")
  TestLiveUrl "$BaseUrl/fr/dhuhr-time" @('<html lang="fr" dir="ltr">', 'href="/fr/dhuhr-time/alger"', 'href="/fr/dhuhr-time/oran"', 'Heure du Dhuhr', 'heure dohr Alger')
  TestLiveUrl "$BaseUrl/fr/asr-time" @('<html lang="fr" dir="ltr">', 'href="/fr/asr-time/alger"', 'href="/fr/asr-time/oran"', 'Heure du Asr', 'heure Asr Alger')
  TestLiveUrl "$BaseUrl/fr/maghrib-time" @('<html lang="fr" dir="ltr">', 'href="/fr/maghrib-time/alger"', 'href="/fr/maghrib-time/bouira"', 'href="/fr/maghrib-time/bejaia"', 'href="/fr/maghrib-time/mostaganem"', 'Heure du Maghrib aujourd', 'adhan maghreb')
  TestLiveUrlRegex "$BaseUrl/fr/maghrib-time" @("<title>Heure du Maghrib aujourd(?:&#39;|'|’)hui \| Recherche quotidienne du Maghrib \| Adantimer</title>")
  TestLiveUrl "$BaseUrl/fr/isha-time" @('<html lang="fr" dir="ltr">', 'href="/fr/isha-time/ain-benian"', "Heure de l'Isha aujourd", 'icha aujourd', 'isha Ain Benian')
  TestLiveUrlRegex "$BaseUrl/fr/isha-time" @("<title>Heure de l'Isha aujourd(?:&#39;|'|’)hui \| Recherche quotidienne de l'Isha \| Adantimer</title>")
  TestLiveUrl "$BaseUrl/tr/prayer-times" @('<html lang="tr" dir="ltr">', 'href="/tr/prayer-times/istanbul"', 'href="/tr/prayer-times/mecca"', 'Bugunun namaz vakitleri', 'ezan saatleri')
  TestLiveUrlRegex "$BaseUrl/tr/prayer-times" @('<title>Bugunun Namaz Vakitleri \| Ezan Saatleri ve Sonraki Namaz \| Adantimer</title>')
  TestLiveUrl "$BaseUrl/tr/next-prayer" @('<html lang="tr" dir="ltr">', 'href="/tr/next-prayer/istanbul"', 'href="/tr/next-prayer/riyadh"', 'ezan ne zaman')
  TestLiveUrlRegex "$BaseUrl/tr/next-prayer" @('<title>Sonraki Namaz Vakti Bugun \| Canli Geri Sayim \| Adantimer</title>')
  TestLiveUrl "$BaseUrl/tr/fajr-time" @('<html lang="tr" dir="ltr">', 'href="/tr/fajr-time/istanbul"', 'href="/tr/fajr-time/medina"', 'fajr vakti')
  TestLiveUrlRegex "$BaseUrl/tr/fajr-time" @('<title>Fajr Vakti Bugun \| Gunluk Fajr Vakti Rehberi \| Adantimer</title>')
  TestLiveUrl "$BaseUrl/tr/maghrib-time" @('<html lang="tr" dir="ltr">', 'href="/tr/maghrib-time/istanbul"', 'href="/tr/maghrib-time/mecca"', 'aksam ezani')
  TestLiveUrlRegex "$BaseUrl/tr/maghrib-time" @('<title>Aksam Ezani ve Maghrib Vakti Bugun \| Gunluk Maghrib Rehberi \| Adantimer</title>')
  TestLiveUrl "$BaseUrl/ar/prayer-times" @('<html lang="ar" dir="rtl">', 'href="/ar/alger"', 'href="/ar/oran"', 'href="/ar/constantine"', 'href="/ar/setif"', 'href="/ar/annaba"', 'href="/ar/bouira"', 'href="/ar/ain-benian"', 'المدينة أو المسجد ومواقيت الصلاة')
  TestLiveUrl "$BaseUrl/ar/dhuhr-time" @('<html lang="ar" dir="rtl">', 'href="/ar/dhuhr-time/alger"', 'href="/ar/dhuhr-time/oran"', 'وقت الظهر', 'وقت الظهر الجزائر العاصمة')
  TestLiveUrl "$BaseUrl/ar/asr-time" @('<html lang="ar" dir="rtl">', 'href="/ar/asr-time/alger"', 'href="/ar/asr-time/oran"', 'وقت العصر', 'وقت العصر الجزائر العاصمة')
  TestLiveUrl "$BaseUrl/ar/isha-time" @('<html lang="ar" dir="rtl">', 'href="/ar/isha-time/alger"', 'href="/ar/isha-time/oran"', 'وقت العشاء', 'وقت العشاء الجزائر العاصمة')
  ...
  TestLiveUrl "$BaseUrl/fajr-time/johor-bahru" @('<body data-page="fajr">', 'Fajr Time in Johor Bahru Today', 'What the Johor Bahru Fajr page should answer first')
  ...
  TestLiveUrl "$BaseUrl/ar/fajr-time" @('<html lang="ar" dir="rtl">', '<body data-page="fajr">', 'href="/ar/fajr-time/alger"', 'href="/ar/fajr-time/batna"', 'href="/ar/fajr-time/setif"')
  TestLiveUrlRegex "$BaseUrl/ar/fajr-time" @('<title>\u0648\u0642\u062a \u0627\u0644\u0641\u062c\u0631 \u0627\u0644\u064a\u0648\u0645 \| \u062f\u0644\u064a\u0644 \u0648\u0642\u062a \u0627\u0644\u0641\u062c\u0631 \u0627\u0644\u064a\u0648\u0645\u064a \| Adantimer</title>','<h1[^>]*>\u0648\u0642\u062a \u0627\u0644\u0641\u062c\u0631 \u0627\u0644\u064a\u0648\u0645</h1>')
  ...
  TestLiveUrl "$BaseUrl/ar/maghrib-time" @('<html lang="ar" dir="rtl">', '<body data-page="maghrib">', 'href="/ar/maghrib-time/alger"', 'href="/ar/maghrib-time/bejaia"', 'href="/ar/maghrib-time/mostaganem"')
  TestLiveUrlRegex "$BaseUrl/ar/maghrib-time" @('<title>\u0648\u0642\u062a \u0627\u0644\u0645\u063a\u0631\u0628 \u0627\u0644\u064a\u0648\u0645 \| \u062f\u0644\u064a\u0644 \u0648\u0642\u062a \u0627\u0644\u0645\u063a\u0631\u0628 \u0627\u0644\u064a\u0648\u0645\u064a \| Adantimer</title>','<h1[^>]*>\u0648\u0642\u062a \u0627\u0644\u0645\u063a\u0631\u0628 \u0627\u0644\u064a\u0648\u0645</h1>')
...
TestLiveUrl "$BaseUrl/annaba" @('<body data-page="home">', 'Prayer Times in Annaba Today', 'How to use the Annaba prayer times page')
TestLiveUrlRegex "$BaseUrl/annaba" @('<title>Prayer Times in Annaba Today \| Fajr, Dhuhr, Asr, Maghrib &(?:amp;|) Isha \| Adantimer</title>')
TestLiveUrl "$BaseUrl/bouira" @('<body data-page="home">', 'Prayer Times in Bouira Today', 'How to use the Bouira prayer times page')
TestLiveUrlRegex "$BaseUrl/bouira" @('<title>Prayer Times in Bouira Today \| Fajr, Dhuhr, Asr, Maghrib &(?:amp;|) Isha \| Adantimer</title>')
TestLiveUrl "$BaseUrl/ain-benian" @('<body data-page="home">', 'Prayer Times in Ain Benian Today', 'How to use the Ain Benian prayer times page')
TestLiveUrlRegex "$BaseUrl/ain-benian" @('<title>Prayer Times in Ain Benian Today \| Fajr, Dhuhr, Asr, Maghrib &(?:amp;|) Isha \| Adantimer</title>')
...
TestLiveUrlRegex "$BaseUrl/chesham" @('<title>Prayer Times in Chesham Today \| Fajr, Dhuhr, Asr, Maghrib &(?:amp;|) Isha \| Adantimer</title>')
  TestLiveUrl "$BaseUrl/fr/oran" @('<html lang="fr" dir="ltr">', '<body data-page="home">', 'Horaires de prière à Oran aujourd', 'horaire priere', 'heure dohr', 'maghreb', 'isha', 'mosquée à Oran', 'quartier', 'href="/fr/next-prayer/oran"', 'href="/fr/fajr-time/oran"', 'href="/fr/alger"', 'href="/fr/constantine"', 'href="/fr/setif"', 'href="/fr/annaba"', 'href="/fr/bouira"', 'href="/fr/ain-benian"')
  ...
  TestLiveUrl "$BaseUrl/fr/alger" @('<html lang="fr" dir="ltr">', '<body data-page="home">', 'Horaires de prière à Alger aujourd', 'heure de prière', 'adhan maghreb', "fajr aujourd", 'quartier', 'href="/fr/next-prayer/alger"', 'href="/fr/maghrib-time/alger"')
  TestLiveUrlRegex "$BaseUrl/fr/alger" @("<title>Horaires de prière à Alger aujourd(?:&#39;|'|’)hui \| Fajr, Dhuhr, Asr, Maghrib &(?:amp;|) Isha \| Adantimer</title>")
  TestLiveUrl "$BaseUrl/fr/next-prayer/alger" @('<html lang="fr" dir="ltr">', '<body data-page="next-prayer">', 'Prochaine prière à Alger aujourd', 'Heure de la prochaine prière')
  TestLiveUrlRegex "$BaseUrl/fr/next-prayer/alger" @("<title>Prochaine prière à Alger aujourd(?:&#39;|'|’)hui \| Compte à rebours en direct \| Adantimer</title>")
  TestLiveUrl "$BaseUrl/fr/fajr-time/alger" @('<html lang="fr" dir="ltr">', '<body data-page="fajr">', 'Heure du Fajr à Alger aujourd', 'mosquée')
  TestLiveUrlRegex "$BaseUrl/fr/fajr-time/alger" @("<title>Heure du Fajr à Alger aujourd(?:&#39;|'|’)hui \| Recherche quotidienne du Fajr \| Adantimer</title>")
  TestLiveUrl "$BaseUrl/fr/maghrib-time/alger" @('<html lang="fr" dir="ltr">', '<body data-page="maghrib">', 'Heure du Maghrib à Alger aujourd', 'mosquée')
  TestLiveUrlRegex "$BaseUrl/fr/maghrib-time/alger" @("<title>Heure du Maghrib à Alger aujourd(?:&#39;|'|’)hui \| Recherche quotidienne du Maghrib \| Adantimer</title>")
  TestLiveUrl "$BaseUrl/fr/next-prayer/tlemcen" @('<html lang="fr" dir="ltr">', '<body data-page="next-prayer">', 'Prochaine prière à Tlemcen aujourd', 'mosquée', 'adhan Tlemcen')
  TestLiveUrlRegex "$BaseUrl/fr/next-prayer/tlemcen" @("<title>Prochaine prière à Tlemcen aujourd(?:&#39;|'|’)hui \| Compte à rebours en direct \| Adantimer</title>")
  TestLiveUrl "$BaseUrl/fr/next-prayer/blida" @('<html lang="fr" dir="ltr">', '<body data-page="next-prayer">', 'Prochaine prière à Blida aujourd', 'mosquée', 'adhan Blida')
  TestLiveUrlRegex "$BaseUrl/fr/next-prayer/blida" @("<title>Prochaine prière à Blida aujourd(?:&#39;|'|’)hui \| Compte à rebours en direct \| Adantimer</title>")
  TestLiveUrl "$BaseUrl/fr/fajr-time/batna" @('<html lang="fr" dir="ltr">', '<body data-page="fajr">', 'Heure du Fajr à Batna aujourd', 'mosquée', 'salat Batna')
  TestLiveUrlRegex "$BaseUrl/fr/fajr-time/batna" @("<title>Heure du Fajr à Batna aujourd(?:&#39;|'|’)hui \| Recherche quotidienne du Fajr \| Adantimer</title>")
  TestLiveUrl "$BaseUrl/fr/dhuhr-time/setif" @('<html lang="fr" dir="ltr">', '<body data-page="dhuhr">', 'Heure du Dhuhr à Setif aujourd', 'mosquée', 'Dohr Setif')
  TestLiveUrlRegex "$BaseUrl/fr/dhuhr-time/setif" @("<title>Heure du Dhuhr à Setif aujourd(?:&#39;|'|’)hui \| Recherche quotidienne du Dhuhr \| Adantimer</title>")
  TestLiveUrl "$BaseUrl/fr/maghrib-time/bejaia" @('<html lang="fr" dir="ltr">', '<body data-page="maghrib">', 'Heure du Maghrib à Bejaia aujourd', 'mosquée', 'adhan Bejaia')
  TestLiveUrlRegex "$BaseUrl/fr/maghrib-time/bejaia" @("<title>Heure du Maghrib à Bejaia aujourd(?:&#39;|'|’)hui \| Recherche quotidienne du Maghrib \| Adantimer</title>")
  TestLiveUrl "$BaseUrl/fr/isha-time/mostaganem" @('<html lang="fr" dir="ltr">', '<body data-page="isha">', "Heure de l'Isha à Mostaganem aujourd", 'mosquée', 'salat Mostaganem')
  TestLiveUrlRegex "$BaseUrl/fr/isha-time/mostaganem" @("<title>Heure de l(?:&#39;|'|’)Isha à Mostaganem aujourd(?:&#39;|'|’)hui \| Recherche quotidienne de l(?:&#39;|'|’)Isha \| Adantimer</title>")
  TestLiveUrl "$BaseUrl/fr/asr-time/constantine" @('<html lang="fr" dir="ltr">', '<body data-page="asr">', 'Heure du Asr à Constantine aujourd', 'mosquée', 'adhan Constantine')
  TestLiveUrlRegex "$BaseUrl/fr/asr-time/constantine" @("<title>Heure du Asr à Constantine aujourd(?:&#39;|'|’)hui \| Recherche quotidienne du Asr \| Adantimer</title>")
  TestLiveUrl "$BaseUrl/fr/asr-time/sidi-bel-abbes" @('<html lang="fr" dir="ltr">', '<body data-page="asr">', 'Heure du Asr à Sidi Bel Abbes aujourd', 'mosquée', 'adhan Sidi Bel Abbes')
  TestLiveUrlRegex "$BaseUrl/fr/asr-time/sidi-bel-abbes" @("<title>Heure du Asr à Sidi Bel Abbes aujourd(?:&#39;|'|’)hui \| Recherche quotidienne du Asr \| Adantimer</title>")
  TestLiveUrl "$BaseUrl/fr/annaba" @('<html lang="fr" dir="ltr">', '<body data-page="home">', 'Horaires de prière à Annaba aujourd', 'adhan', 'maghreb', 'href="/fr/next-prayer/annaba"', 'href="/fr/maghrib-time/annaba"')
  TestLiveUrlRegex "$BaseUrl/fr/annaba" @("<title>Horaires de prière à Annaba aujourd(?:&#39;|'|’)hui \| Fajr, Dhuhr, Asr, Maghrib &(?:amp;|) Isha \| Adantimer</title>")
  TestLiveUrl "$BaseUrl/fr/bouira" @('<html lang="fr" dir="ltr">', '<body data-page="home">', 'Horaires de prière à Bouira aujourd', 'adhan maghreb', 'maghrib', 'href="/fr/next-prayer/bouira"', 'href="/fr/maghrib-time/bouira"')
  ...
  TestLiveUrl "$BaseUrl/fr/ain-benian" @('<html lang="fr" dir="ltr">', '<body data-page="home">', 'Horaires de prière à Ain Benian aujourd', 'icha', 'Isha', 'href="/fr/next-prayer/ain-benian"', 'href="/fr/isha-time/ain-benian"')
  ...
  TestLiveUrl "$BaseUrl/fr/constantine" @('<html lang="fr" dir="ltr">', '<body data-page="home">', 'Horaires de prière à Constantine aujourd', 'href="/fr/next-prayer/constantine"', 'href="/fr/fajr-time/constantine"', 'href="/fr/setif"', 'href="/fr/blida"')
  TestLiveUrl "$BaseUrl/fr/constantine" @('mosquee Constantine', 'adhan Constantine')
  ...
  TestLiveUrl "$BaseUrl/fr/setif" @('<html lang="fr" dir="ltr">', '<body data-page="home">', 'Horaires de prière à Setif aujourd', 'href="/fr/next-prayer/setif"', 'href="/fr/fajr-time/setif"', 'href="/fr/constantine"', 'href="/fr/blida"')
  TestLiveUrlRegex "$BaseUrl/fr/setif" @("<title>Horaires de prière à Setif aujourd(?:&#39;|'|’)hui \| Fajr, Dhuhr, Asr, Maghrib &(?:amp;|) Isha \| Adantimer</title>")
  TestLiveUrl "$BaseUrl/fr/blida" @('<html lang="fr" dir="ltr">', '<body data-page="home">', 'Horaires de prière à Blida aujourd', 'href="/fr/next-prayer/blida"', 'href="/fr/maghrib-time/blida"', 'href="/fr/constantine"', 'href="/fr/setif"')
  ...
  TestLiveUrl "$BaseUrl/fr/tlemcen" @('<html lang="fr" dir="ltr">', '<body data-page="home">', 'Horaires de prière à Tlemcen aujourd', 'href="/fr/next-prayer/tlemcen"', 'href="/fr/maghrib-time/tlemcen"', 'href="/fr/alger"', 'href="/fr/oran"')
  TestLiveUrlRegex "$BaseUrl/fr/tlemcen" @("<title>Horaires de prière à Tlemcen aujourd(?:&#39;|'|’)hui \| Fajr, Dhuhr, Asr, Maghrib &(?:amp;|) Isha \| Adantimer</title>")
  TestLiveUrl "$BaseUrl/fr/batna" @('<html lang="fr" dir="ltr">', '<body data-page="home">', 'Horaires de prière à Batna aujourd', 'href="/fr/next-prayer/batna"', 'href="/fr/fajr-time/batna"', 'href="/fr/alger"', 'href="/fr/constantine"')
  TestLiveUrlRegex "$BaseUrl/fr/batna" @("<title>Horaires de prière à Batna aujourd(?:&#39;|'|’)hui \| Fajr, Dhuhr, Asr, Maghrib &(?:amp;|) Isha \| Adantimer</title>")
  TestLiveUrl "$BaseUrl/fr/bejaia" @('<html lang="fr" dir="ltr">', '<body data-page="home">', 'Horaires de prière à Bejaia aujourd', 'href="/fr/next-prayer/bejaia"', 'href="/fr/maghrib-time/bejaia"', 'href="/fr/alger"', 'href="/fr/bouira"')
  TestLiveUrl "$BaseUrl/fr/bejaia" @('mosquee Bejaia', 'adhan Bejaia')
  TestLiveUrlRegex "$BaseUrl/fr/bejaia" @("<title>Horaires de prière à Bejaia aujourd(?:&#39;|'|’)hui \| Fajr, Dhuhr, Asr, Maghrib &(?:amp;|) Isha \| Adantimer</title>")
  TestLiveUrl "$BaseUrl/fr/mostaganem" @('<html lang="fr" dir="ltr">', '<body data-page="home">', 'Horaires de prière à Mostaganem aujourd', 'href="/fr/next-prayer/mostaganem"', 'href="/fr/isha-time/mostaganem"', 'href="/fr/alger"', 'href="/fr/oran"')
  TestLiveUrlRegex "$BaseUrl/fr/mostaganem" @("<title>Horaires de prière à Mostaganem aujourd(?:&#39;|'|’)hui \| Fajr, Dhuhr, Asr, Maghrib &(?:amp;|) Isha \| Adantimer</title>")
  TestLiveUrl "$BaseUrl/fr/sidi-bel-abbes" @('<html lang="fr" dir="ltr">', '<body data-page="home">', 'Horaires de prière à Sidi Bel Abbes aujourd', 'href="/fr/next-prayer/sidi-bel-abbes"', 'href="/fr/fajr-time/sidi-bel-abbes"', 'href="/fr/tlemcen"', 'href="/fr/oran"')
  ...
  TestLiveUrl "$BaseUrl/ar/oran" @('<html lang="ar" dir="rtl">', '<body data-page="home">', 'الصلاة القادمة', 'وقت الفجر', 'مواقيت مسجد في وهران', 'مسجد وهران', 'الحي', 'href="/ar/next-prayer/oran"', 'href="/ar/fajr-time/oran"', 'href="/ar/alger"', 'href="/ar/constantine"', 'href="/ar/setif"', 'href="/ar/annaba"', 'href="/ar/bouira"', 'href="/ar/ain-benian"')
  ...
  TestLiveUrl "$BaseUrl/ar/alger" @('<html lang="ar" dir="rtl">', '<body data-page="home">', 'الجزائر العاصمة', 'الصلاة القادمة', 'الحي', 'href="/ar/next-prayer/alger"', 'href="/ar/maghrib-time/alger"')
  TestLiveUrlRegex "$BaseUrl/ar/alger" @('<title>\u0645\u0648\u0627\u0642\u064a\u062a \u0627\u0644\u0635\u0644\u0627\u0629 \u0641\u064a \u0627\u0644\u062c\u0632\u0627\u0626\u0631 \u0627\u0644\u0639\u0627\u0635\u0645\u0629 \u0627\u0644\u064a\u0648\u0645 \| \u0627\u0644\u0641\u062c\u0631 \u0648\u0627\u0644\u0638\u0647\u0631 \u0648\u0627\u0644\u0639\u0635\u0631 \u0648\u0627\u0644\u0645\u063a\u0631\u0628 \u0648\u0627\u0644\u0639\u0634\u0627\u0621 \| Adantimer</title>', '<h1[^>]*>\u0645\u0648\u0627\u0642\u064a\u062a \u0627\u0644\u0635\u0644\u0627\u0629 \u0641\u064a \u0627\u0644\u062c\u0632\u0627\u0626\u0631 \u0627\u0644\u0639\u0627\u0635\u0645\u0629 \u0627\u0644\u064a\u0648\u0645</h1>')
  TestLiveUrl "$BaseUrl/ar/next-prayer/alger" @('<html lang="ar" dir="rtl">', '<body data-page="next-prayer">', 'الصلاة القادمة', 'الجزائر العاصمة')
  TestLiveUrlRegex "$BaseUrl/ar/next-prayer/alger" @('<title>\u0627\u0644\u0635\u0644\u0627\u0629 \u0627\u0644\u0642\u0627\u062f\u0645\u0629 \u0641\u064a \u0627\u0644\u062c\u0632\u0627\u0626\u0631 \u0627\u0644\u0639\u0627\u0635\u0645\u0629 \u0627\u0644\u064a\u0648\u0645 \| \u0639\u062f \u062a\u0646\u0627\u0632\u0644\u064a \u0645\u0628\u0627\u0634\u0631 \u0644\u0644\u0635\u0644\u0627\u0629 \| Adantimer</title>')
  TestLiveUrl "$BaseUrl/ar/fajr-time/alger" @('<html lang="ar" dir="rtl">', '<body data-page="fajr">', 'وقت الفجر', 'الجزائر العاصمة')
  TestLiveUrlRegex "$BaseUrl/ar/fajr-time/alger" @('<title>\u0648\u0642\u062a \u0627\u0644\u0641\u062c\u0631 \u0641\u064a \u0627\u0644\u062c\u0632\u0627\u0626\u0631 \u0627\u0644\u0639\u0627\u0635\u0645\u0629 \u0627\u0644\u064a\u0648\u0645 \| \u062f\u0644\u064a\u0644 \u0648\u0642\u062a \u0627\u0644\u0641\u062c\u0631 \u0627\u0644\u064a\u0648\u0645\u064a \| Adantimer</title>')
  TestLiveUrl "$BaseUrl/ar/maghrib-time/alger" @('<html lang="ar" dir="rtl">', '<body data-page="maghrib">', 'وقت المغرب', 'الجزائر العاصمة')
  TestLiveUrlRegex "$BaseUrl/ar/maghrib-time/alger" @('<title>\u0648\u0642\u062a \u0627\u0644\u0645\u063a\u0631\u0628 \u0641\u064a \u0627\u0644\u062c\u0632\u0627\u0626\u0631 \u0627\u0644\u0639\u0627\u0635\u0645\u0629 \u0627\u0644\u064a\u0648\u0645 \| \u062f\u0644\u064a\u0644 \u0648\u0642\u062a \u0627\u0644\u0645\u063a\u0631\u0628 \u0627\u0644\u064a\u0648\u0645\u064a \| Adantimer</title>')
  TestLiveUrl "$BaseUrl/ar/next-prayer/tlemcen" @('<html lang="ar" dir="rtl">', '<body data-page="next-prayer">', 'الصلاة القادمة', 'تلمسان', 'مسجد', 'اذان تلمسان')
  TestLiveUrlRegex "$BaseUrl/ar/next-prayer/tlemcen" @('<title>\u0627\u0644\u0635\u0644\u0627\u0629 \u0627\u0644\u0642\u0627\u062f\u0645\u0629 \u0641\u064a \u062a\u0644\u0645\u0633\u0627\u0646 \u0627\u0644\u064a\u0648\u0645 \| \u0639\u062f \u062a\u0646\u0627\u0632\u0644\u064a \u0645\u0628\u0627\u0634\u0631 \u0644\u0644\u0635\u0644\u0627\u0629 \| Adantimer</title>')
  TestLiveUrl "$BaseUrl/ar/next-prayer/blida" @('<html lang="ar" dir="rtl">', '<body data-page="next-prayer">', 'الصلاة القادمة', 'البليدة', 'مسجد', 'اذان البليدة')
  TestLiveUrlRegex "$BaseUrl/ar/next-prayer/blida" @('<title>\u0627\u0644\u0635\u0644\u0627\u0629 \u0627\u0644\u0642\u0627\u062f\u0645\u0629 \u0641\u064a \u0627\u0644\u0628\u0644\u064a\u062f\u0629 \u0627\u0644\u064a\u0648\u0645 \| \u0639\u062f \u062a\u0646\u0627\u0632\u0644\u064a \u0645\u0628\u0627\u0634\u0631 \u0644\u0644\u0635\u0644\u0627\u0629 \| Adantimer</title>')
  TestLiveUrl "$BaseUrl/ar/fajr-time/batna" @('<html lang="ar" dir="rtl">', '<body data-page="fajr">', 'وقت الفجر', 'باتنة', 'مسجد', 'صلاة باتنة')
  TestLiveUrlRegex "$BaseUrl/ar/fajr-time/batna" @('<title>\u0648\u0642\u062a \u0627\u0644\u0641\u062c\u0631 \u0641\u064a \u0628\u0627\u062a\u0646\u0629 \u0627\u0644\u064a\u0648\u0645 \| \u062f\u0644\u064a\u0644 \u0648\u0642\u062a \u0627\u0644\u0641\u062c\u0631 \u0627\u0644\u064a\u0648\u0645\u064a \| Adantimer</title>')
  TestLiveUrl "$BaseUrl/ar/dhuhr-time/setif" @('<html lang="ar" dir="rtl">', '<body data-page="dhuhr">', 'وقت الظهر', 'سطيف', 'مسجد', 'اذان الظهر')
  TestLiveUrlRegex "$BaseUrl/ar/dhuhr-time/setif" @('<title>\u0648\u0642\u062a \u0627\u0644\u0638\u0647\u0631 \u0641\u064a \u0633\u0637\u064a\u0641 \u0627\u0644\u064a\u0648\u0645 \| \u062f\u0644\u064a\u0644 \u0648\u0642\u062a \u0627\u0644\u0638\u0647\u0631 \u0627\u0644\u064a\u0648\u0645\u064a \| Adantimer</title>')
  TestLiveUrl "$BaseUrl/ar/maghrib-time/bejaia" @('<html lang="ar" dir="rtl">', '<body data-page="maghrib">', 'وقت المغرب', 'بجاية', 'مسجد', 'اذان بجاية')
  TestLiveUrlRegex "$BaseUrl/ar/maghrib-time/bejaia" @('<title>\u0648\u0642\u062a \u0627\u0644\u0645\u063a\u0631\u0628 \u0641\u064a \u0628\u062c\u0627\u064a\u0629 \u0627\u0644\u064a\u0648\u0645 \| \u062f\u0644\u064a\u0644 \u0648\u0642\u062a \u0627\u0644\u0645\u063a\u0631\u0628 \u0627\u0644\u064a\u0648\u0645\u064a \| Adantimer</title>')
  TestLiveUrl "$BaseUrl/ar/isha-time/mostaganem" @('<html lang="ar" dir="rtl">', '<body data-page="isha">', 'وقت العشاء', 'مستغانم', 'مسجد', 'صلاة مستغانم')
  TestLiveUrlRegex "$BaseUrl/ar/isha-time/mostaganem" @('<title>\u0648\u0642\u062a \u0627\u0644\u0639\u0634\u0627\u0621 \u0641\u064a \u0645\u0633\u062a\u063a\u0627\u0646\u0645 \u0627\u0644\u064a\u0648\u0645 \| \u062f\u0644\u064a\u0644 \u0648\u0642\u062a \u0627\u0644\u0639\u0634\u0627\u0621 \u0627\u0644\u064a\u0648\u0645\u064a \| Adantimer</title>')
  TestLiveUrl "$BaseUrl/ar/asr-time/constantine" @('<html lang="ar" dir="rtl">', '<body data-page="asr">', 'وقت العصر', 'قسنطينة', 'مسجد', 'اذان قسنطينة')
  TestLiveUrlRegex "$BaseUrl/ar/asr-time/constantine" @('<title>\u0648\u0642\u062a \u0627\u0644\u0639\u0635\u0631 \u0641\u064a \u0642\u0633\u0646\u0637\u064a\u0646\u0629 \u0627\u0644\u064a\u0648\u0645 \| \u062f\u0644\u064a\u0644 \u0648\u0642\u062a \u0627\u0644\u0639\u0635\u0631 \u0627\u0644\u064a\u0648\u0645\u064a \| Adantimer</title>')
  TestLiveUrl "$BaseUrl/ar/asr-time/sidi-bel-abbes" @('<html lang="ar" dir="rtl">', '<body data-page="asr">', 'وقت العصر', 'سيدي بلعباس', 'مسجد', 'اذان العصر')
  TestLiveUrlRegex "$BaseUrl/ar/asr-time/sidi-bel-abbes" @('<title>\u0648\u0642\u062a \u0627\u0644\u0639\u0635\u0631 \u0641\u064a \u0633\u064a\u062f\u064a \u0628\u0644\u0639\u0628\u0627\u0633 \u0627\u0644\u064a\u0648\u0645 \| \u062f\u0644\u064a\u0644 \u0648\u0642\u062a \u0627\u0644\u0639\u0635\u0631 \u0627\u0644\u064a\u0648\u0645\u064a \| Adantimer</title>')
  TestLiveUrl "$BaseUrl/ar/annaba" @('<html lang="ar" dir="rtl">', '<body data-page="home">', 'وقت المغرب', 'الصلاة القادمة', 'href="/ar/next-prayer/annaba"', 'href="/ar/maghrib-time/annaba"')
  TestLiveUrlRegex "$BaseUrl/ar/annaba" @('<title>\u0645\u0648\u0627\u0642\u064a\u062a \u0627\u0644\u0635\u0644\u0627\u0629 \u0641\u064a \u0639\u0646\u0627\u0628\u0629 \u0627\u0644\u064a\u0648\u0645 \| \u0627\u0644\u0641\u062c\u0631 \u0648\u0627\u0644\u0638\u0647\u0631 \u0648\u0627\u0644\u0639\u0635\u0631 \u0648\u0627\u0644\u0645\u063a\u0631\u0628 \u0648\u0627\u0644\u0639\u0634\u0627\u0621 \| Adantimer</title>', '<h1[^>]*>\u0645\u0648\u0627\u0642\u064a\u062a \u0627\u0644\u0635\u0644\u0627\u0629 \u0641\u064a \u0639\u0646\u0627\u0628\u0629 \u0627\u0644\u064a\u0648\u0645</h1>')
TestLiveUrl "$BaseUrl/ar/bouira" @('<html lang="ar" dir="rtl">', '<body data-page="home">', 'وقت المغرب', 'مواقيت الصلاة', 'href="/ar/next-prayer/bouira"', 'href="/ar/maghrib-time/bouira"')
...
TestLiveUrl "$BaseUrl/ar/ain-benian" @('<html lang="ar" dir="rtl">', '<body data-page="home">', 'وقت العشاء', 'الصلاة القادمة', 'href="/ar/next-prayer/ain-benian"', 'href="/ar/isha-time/ain-benian"')
TestLiveUrlRegex "$BaseUrl/ar/ain-benian" @('<title>\u0645\u0648\u0627\u0642\u064a\u062a \u0627\u0644\u0635\u0644\u0627\u0629 \u0641\u064a \u0639\u064a\u0646 \u0627\u0644\u0628\u0646\u064a\u0627\u0646 \u0627\u0644\u064a\u0648\u0645 \| \u0627\u0644\u0641\u062c\u0631 \u0648\u0627\u0644\u0638\u0647\u0631 \u0648\u0627\u0644\u0639\u0635\u0631 \u0648\u0627\u0644\u0645\u063a\u0631\u0628 \u0648\u0627\u0644\u0639\u0634\u0627\u0621 \| Adantimer</title>', '<h1[^>]*>\u0645\u0648\u0627\u0642\u064a\u062a \u0627\u0644\u0635\u0644\u0627\u0629 \u0641\u064a \u0639\u064a\u0646 \u0627\u0644\u0628\u0646\u064a\u0627\u0646 \u0627\u0644\u064a\u0648\u0645</h1>')
  TestLiveUrl "$BaseUrl/ar/constantine" @('<html lang="ar" dir="rtl">', '<body data-page="home">', 'قسنطينة', 'href="/ar/next-prayer/constantine"', 'href="/ar/fajr-time/constantine"', 'href="/ar/setif"', 'href="/ar/blida"')
  TestLiveUrl "$BaseUrl/ar/constantine" @('مسجد قسنطينة', 'اذان قسنطينة')
...
TestLiveUrl "$BaseUrl/ar/setif" @('<html lang="ar" dir="rtl">', '<body data-page="home">', 'سطيف', 'href="/ar/next-prayer/setif"', 'href="/ar/fajr-time/setif"', 'href="/ar/constantine"', 'href="/ar/blida"')
TestLiveUrlRegex "$BaseUrl/ar/setif" @('<title>\u0645\u0648\u0627\u0642\u064a\u062a \u0627\u0644\u0635\u0644\u0627\u0629 \u0641\u064a \u0633\u0637\u064a\u0641 \u0627\u0644\u064a\u0648\u0645 \| \u0627\u0644\u0641\u062c\u0631 \u0648\u0627\u0644\u0638\u0647\u0631 \u0648\u0627\u0644\u0639\u0635\u0631 \u0648\u0627\u0644\u0645\u063a\u0631\u0628 \u0648\u0627\u0644\u0639\u0634\u0627\u0621 \| Adantimer</title>')
TestLiveUrl "$BaseUrl/ar/blida" @('<html lang="ar" dir="rtl">', '<body data-page="home">', 'البليدة', 'href="/ar/next-prayer/blida"', 'href="/ar/maghrib-time/blida"', 'href="/ar/constantine"', 'href="/ar/setif"')
...
TestLiveUrl "$BaseUrl/ar/tlemcen" @('<html lang="ar" dir="rtl">', '<body data-page="home">', 'تلمسان', 'href="/ar/next-prayer/tlemcen"', 'href="/ar/maghrib-time/tlemcen"', 'href="/ar/alger"', 'href="/ar/oran"')
TestLiveUrlRegex "$BaseUrl/ar/tlemcen" @('<title>\u0645\u0648\u0627\u0642\u064a\u062a \u0627\u0644\u0635\u0644\u0627\u0629 \u0641\u064a \u062a\u0644\u0645\u0633\u0627\u0646 \u0627\u0644\u064a\u0648\u0645 \| \u0627\u0644\u0641\u062c\u0631 \u0648\u0627\u0644\u0638\u0647\u0631 \u0648\u0627\u0644\u0639\u0635\u0631 \u0648\u0627\u0644\u0645\u063a\u0631\u0628 \u0648\u0627\u0644\u0639\u0634\u0627\u0621 \| Adantimer</title>')
TestLiveUrl "$BaseUrl/ar/batna" @('<html lang="ar" dir="rtl">', '<body data-page="home">', 'باتنة', 'href="/ar/next-prayer/batna"', 'href="/ar/fajr-time/batna"', 'href="/ar/alger"', 'href="/ar/constantine"')
TestLiveUrlRegex "$BaseUrl/ar/batna" @('<title>\u0645\u0648\u0627\u0642\u064a\u062a \u0627\u0644\u0635\u0644\u0627\u0629 \u0641\u064a \u0628\u0627\u062a\u0646\u0629 \u0627\u0644\u064a\u0648\u0645 \| \u0627\u0644\u0641\u062c\u0631 \u0648\u0627\u0644\u0638\u0647\u0631 \u0648\u0627\u0644\u0639\u0635\u0631 \u0648\u0627\u0644\u0645\u063a\u0631\u0628 \u0648\u0627\u0644\u0639\u0634\u0627\u0621 \| Adantimer</title>')
  TestLiveUrl "$BaseUrl/ar/bejaia" @('<html lang="ar" dir="rtl">', '<body data-page="home">', 'بجاية', 'href="/ar/next-prayer/bejaia"', 'href="/ar/maghrib-time/bejaia"', 'href="/ar/alger"', 'href="/ar/bouira"')
  TestLiveUrl "$BaseUrl/ar/bejaia" @('مسجد بجاية', 'اذان بجاية')
  TestLiveUrlRegex "$BaseUrl/ar/bejaia" @('<title>\u0645\u0648\u0627\u0642\u064a\u062a \u0627\u0644\u0635\u0644\u0627\u0629 \u0641\u064a \u0628\u062c\u0627\u064a\u0629 \u0627\u0644\u064a\u0648\u0645 \| \u0627\u0644\u0641\u062c\u0631 \u0648\u0627\u0644\u0638\u0647\u0631 \u0648\u0627\u0644\u0639\u0635\u0631 \u0648\u0627\u0644\u0645\u063a\u0631\u0628 \u0648\u0627\u0644\u0639\u0634\u0627\u0621 \| Adantimer</title>')
TestLiveUrl "$BaseUrl/ar/mostaganem" @('<html lang="ar" dir="rtl">', '<body data-page="home">', 'مستغانم', 'href="/ar/next-prayer/mostaganem"', 'href="/ar/isha-time/mostaganem"', 'href="/ar/alger"', 'href="/ar/oran"')
TestLiveUrlRegex "$BaseUrl/ar/mostaganem" @('<title>\u0645\u0648\u0627\u0642\u064a\u062a \u0627\u0644\u0635\u0644\u0627\u0629 \u0641\u064a \u0645\u0633\u062a\u063a\u0627\u0646\u0645 \u0627\u0644\u064a\u0648\u0645 \| \u0627\u0644\u0641\u062c\u0631 \u0648\u0627\u0644\u0638\u0647\u0631 \u0648\u0627\u0644\u0639\u0635\u0631 \u0648\u0627\u0644\u0645\u063a\u0631\u0628 \u0648\u0627\u0644\u0639\u0634\u0627\u0621 \| Adantimer</title>')
TestLiveUrl "$BaseUrl/ar/sidi-bel-abbes" @('<html lang="ar" dir="rtl">', '<body data-page="home">', 'سيدي بلعباس', 'href="/ar/next-prayer/sidi-bel-abbes"', 'href="/ar/fajr-time/sidi-bel-abbes"', 'href="/ar/tlemcen"', 'href="/ar/oran"')
