...
if ($RunLive) {
  ...
  TestLiveUrl "$BaseUrl/fr/prayer-times" @('<html lang="fr" dir="ltr">', 'href="/fr/alger"', 'href="/fr/oran"', 'href="/fr/constantine"', 'href="/fr/setif"', 'href="/fr/annaba"', 'href="/fr/bouira"', 'href="/fr/ain-benian"', 'horaire priere', 'adhan aujourd')
  TestLiveUrl "$BaseUrl/fr/next-prayer" @('<html lang="fr" dir="ltr">', 'href="/fr/next-prayer/alger"', 'href="/fr/next-prayer/oran"', 'href="/fr/next-prayer/tlemcen"', 'href="/fr/next-prayer/sidi-bel-abbes"', 'Prochaine prière aujourd', 'adhan aujourd')
  ...
  TestLiveUrl "$BaseUrl/ar/prayer-times" @('<html lang="ar" dir="rtl">', 'href="/ar/alger"', 'href="/ar/oran"', 'href="/ar/constantine"', 'href="/ar/setif"', 'href="/ar/annaba"', 'href="/ar/bouira"', 'href="/ar/ain-benian"')
