...
if ($RunLive) {
  ...
  TestLiveUrlRegex "$BaseUrl/prayer-times" @('<title>Prayer Times Today \| Fajr, Dhuhr, Asr, Maghrib & Isha \| Adantimer</title>')
  ...
  TestLiveUrlRegex "$BaseUrl/dubai" @('<title>Prayer Times in Dubai Today \| Fajr, Dhuhr, Asr, Maghrib & Isha \| Adantimer</title>')
  TestLiveUrl "$BaseUrl/mecca" @('<body data-page="home">', 'Prayer Times in Mecca Today', 'How to use the Mecca prayer times page')
  TestLiveUrlRegex "$BaseUrl/mecca" @('<title>Prayer Times in Mecca Today \| Fajr, Dhuhr, Asr, Maghrib & Isha \| Adantimer</title>')
