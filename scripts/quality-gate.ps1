...
if ($RunLive) {
  ...
  TestLiveUrl "$BaseUrl/fr/fajr-time" @('<html lang="fr" dir="ltr">', 'href="/fr/fajr-time/oran"', 'Heure du Fajr aujourd', 'heure du fajr')
  TestLiveUrlRegex "$BaseUrl/fr/fajr-time" @("<title>Heure du Fajr aujourd(?:&#39;|'|’)hui \| Recherche quotidienne du Fajr \| Adantimer</title>")
  TestLiveUrl "$BaseUrl/fr/maghrib-time" @('<html lang="fr" dir="ltr">', 'href="/fr/maghrib-time/bouira"', 'Heure du Maghrib aujourd', 'adhan maghreb')
