...
TestLiveUrlRegex "$BaseUrl/chesham" @('<title>Prayer Times in Chesham Today \| Fajr, Dhuhr, Asr, Maghrib &(?:amp;|) Isha \| Adantimer</title>')
  ...
  TestLiveUrl "$BaseUrl/fr/next-prayer/tlemcen" @('<html lang="fr" dir="ltr">', '<body data-page="next-prayer">', 'Prochaine prière à Tlemcen aujourd', 'mosquée')
  ...
  TestLiveUrl "$BaseUrl/fr/fajr-time/batna" @('<html lang="fr" dir="ltr">', '<body data-page="fajr">', 'Heure du Fajr à Batna aujourd', 'mosquée')
  ...
  TestLiveUrl "$BaseUrl/fr/maghrib-time/bejaia" @('<html lang="fr" dir="ltr">', '<body data-page="maghrib">', 'Heure du Maghrib à Bejaia aujourd', 'mosquée')
  ...
  TestLiveUrl "$BaseUrl/fr/isha-time/mostaganem" @('<html lang="fr" dir="ltr">', '<body data-page="isha">', "Heure de l'Isha à Mostaganem aujourd", 'mosquée')
  ...
  TestLiveUrl "$BaseUrl/fr/asr-time/constantine" @('<html lang="fr" dir="ltr">', '<body data-page="asr">', 'Heure du Asr à Constantine aujourd', 'mosquée')
  ...
  TestLiveUrl "$BaseUrl/ar/next-prayer/tlemcen" @('<html lang="ar" dir="rtl">', '<body data-page="next-prayer">', 'الصلاة القادمة', 'تلمسان', 'مسجد')
  ...
  TestLiveUrl "$BaseUrl/ar/fajr-time/batna" @('<html lang="ar" dir="rtl">', '<body data-page="fajr">', 'وقت الفجر', 'باتنة', 'مسجد')
  TestLiveUrlRegex "$BaseUrl/ar/fajr-time/batna" @('<title>\u0648\u0642\u062a \u0627\u0644\u0641\u062c\u0631 \u0641\u064a \u0628\u0627\u062a\u0646\u0629 \u0627\u0644\u064a\u0648\u0645 \| \u062f\u0644\u064a\u0644 \u0648\u0642\u062a \u0627\u0644\u0641\u062c\u0631 \u0627\u0644\u064a\u0648\u0645\u064a \| Adantimer</title>')
  TestLiveUrl "$BaseUrl/ar/maghrib-time/bejaia" @('<html lang="ar" dir="rtl">', '<body data-page="maghrib">', 'وقت المغرب', 'بجاية', 'مسجد')
  TestLiveUrlRegex "$BaseUrl/ar/maghrib-time/bejaia" @('<title>\u0648\u0642\u062a \u0627\u0644\u0645\u063a\u0631\u0628 \u0641\u064a \u0628\u062c\u0627\u064a\u0629 \u0627\u0644\u064a\u0648\u0645 \| \u062f\u0644\u064a\u0644 \u0648\u0642\u062a \u0627\u0644\u0645\u063a\u0631\u0628 \u0627\u0644\u064a\u0648\u0645\u064a \| Adantimer</title>')
  TestLiveUrl "$BaseUrl/ar/isha-time/mostaganem" @('<html lang="ar" dir="rtl">', '<body data-page="isha">', 'وقت العشاء', 'مستغانم', 'مسجد')
  ...
  TestLiveUrl "$BaseUrl/ar/asr-time/constantine" @('<html lang="ar" dir="rtl">', '<body data-page="asr">', 'وقت العصر', 'قسنطينة', 'مسجد')
