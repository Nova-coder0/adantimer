...
AssertContains $renderJs 'Object.assign(copy, buildEnglishPriorityIntentCopy("prayer-times"));' "SSR renderer routes prayer-times through the shared English intent builder" "SSR renderer no longer routes prayer-times through the shared English intent builder"
AssertContains $renderJs 'Object.assign(copy, buildEnglishPriorityIntentCopy("next-prayer"));' "SSR renderer routes next-prayer through the shared English intent builder" "SSR renderer no longer routes next-prayer through the shared English intent builder"
AssertContains $renderJs 'Object.assign(copy, buildEnglishPriorityIntentCopy(pageType));' "SSR renderer routes English prayer-intent pages through the shared builder" "SSR renderer no longer routes English prayer-intent pages through the shared builder"
