...
TestLiveUrlRegex "$BaseUrl/chesham" @('<title>Prayer Times in Chesham Today \| Fajr, Dhuhr, Asr, Maghrib &(?:amp;|) Isha \| Adantimer</title>')
  ...
  TestLiveUrl "$BaseUrl/fr/tlemcen" @('<html lang="fr" dir="ltr">', '<body data-page="home">', 'Horaires de prière à Tlemcen aujourd', 'href="/fr/alger"', 'href="/fr/oran"')
...
TestLiveUrl "$BaseUrl/ar/tlemcen" @('<html lang="ar" dir="rtl">', '<body data-page="home">', 'تلمسان', 'href="/ar/alger"', 'href="/ar/oran"')
