...
AssertContains $renderJs 'const ENGLISH_PRIORITY_HOME_GENERIC_SLUGS = new Set(' "SSR renderer derives the second English priority city switch from central config" "SSR renderer is missing the derived second English priority city switch"
AssertContains $renderJs 'return buildEnglishPriorityHomeCityCopy("Dubai", "dubai");' "SSR renderer routes Dubai through the shared English priority builder" "SSR renderer no longer routes Dubai through the shared English priority builder"
AssertContains $renderJs 'return buildEnglishPriorityHomeCityCopy("Mecca", "mecca");' "SSR renderer routes Mecca through the shared English priority builder" "SSR renderer no longer routes Mecca through the shared English priority builder"
...
AssertContains $renderJs 'const ARABIC_PRIORITY_HOME_GENERIC_SLUGS = new Set(' "SSR renderer derives the Arabic core priority city switch from central config" "SSR renderer is missing the derived Arabic core priority city switch"
...
AssertContains $renderJs 'if (cityKey === "dubai") {' "SSR renderer keeps the Arabic Dubai branch inside the shared home-city resolver" "SSR renderer is missing the Arabic Dubai branch inside the shared home-city resolver"
