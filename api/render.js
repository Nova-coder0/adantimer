...
function getAlgeriaFocusCities(sourceCity = "") {
  ...
  const ordered = [
    ...ALGERIA_WINNER_CITY_SLUGS
      .map(slug => ALGERIA_FOCUS_CITIES.find(city => slugify(city) === slug))
      .filter(Boolean),
    ...ALGERIA_FOCUS_CITIES.filter(city => !ALGERIA_WINNER_CITY_SLUGS.includes(slugify(city)))
  ];
  return ordered.filter(city => slugify(city) !== sourceSlug);
}
...
function buildFrenchGscWinnerHomeCityCopy(cityName, variant = "generic") {
  const variantConfig = {
    ...
    constantine: {
      infoTitle: `Horaires de prière à ${cityName} avec comparaison locale et autres grandes villes d'Algérie`,
      features: [
        `Consultez les horaires de prière à ${cityName} aujourd'hui avec Fajr, Dhuhr, Asr, Maghrib, Isha et le compte à rebours jusqu'à la prochaine prière.`,
        "Le statut de la prière en cours, la date du jour et la méthode de calcul restent visibles sur la même page pour une vérification plus rapide.",
        `Depuis ${cityName}, vous pouvez comparer directement Alger, Sétif, Blida, Annaba ou Batna sans quitter le bloc Algérie que nous priorisons.`,
        "La page couvre aussi les formulations locales comme horaire priere, horaires de prière, adhan, dohr, maghreb et icha sans créer de variantes faibles."
      ],
      aboutParagraphs: [
        `Cette page est conçue pour la recherche directe : horaires de prière à ${cityName} aujourd'hui, avec le planning complet visible immédiatement.`,
        "Le tableau du jour, le compte à rebours et la méthode affichée restent ensemble pour que la réponse soit plus rapide à vérifier.",
        `Si vous comparez avec une mosquée locale ou un autre site, utilisez cette page comme point d'entrée rapide puis confrontez la méthode visible à l'autorité locale que vous suivez.`,
        `Si votre recherche mentionne une mosquée précise à ${cityName}, utilisez d'abord cette page de ville puis comparez le tableau local de cette mosquée avec la méthode affichée.`,
        "Le bloc des autres villes vous permet aussi de passer rapidement vers Alger, Sétif, Blida, Annaba ou Batna pour comparer les horaires dans un même contexte algérien.",
        "Pour Constantine, la couverture vise surtout les recherches de ville complète, les comparaisons avec d'autres grandes villes de l'est algérien et les requêtes de type adhan ou horaire priere."
      ],
      faq: [
        {
          question: `Cette page ${cityName} affiche-t-elle les cinq prières du jour ?`,
        ...
        {
          question: `Puis-je comparer rapidement ${cityName} avec d'autres villes d'Algérie ?`,
          answer: "Oui. Les autres villes vous donnent un accès direct à Alger, Sétif, Blida, Annaba et Batna pour comparer rapidement les horaires algériens."
        },
        {
          question: `Puis-je utiliser cette page si je cherche les horaires d'une mosquée à ${cityName} ?`,
          answer: "Oui. Cette page sert de référence rapide pour Constantine, puis vous pouvez confronter le tableau affiché à la mosquée ou au quartier que vous suivez."
        },
        {
          question: `Les horaires de prière à ${cityName} peuvent-ils varier selon la source ?`,
          answer: "Oui. Les horaires peuvent varier selon la méthode de calcul ou la référence locale, donc comparez aussi avec votre mosquée si nécessaire."
    ...
    setif: {
      infoTitle: `Horaires de prière à ${cityName} avec le planning du jour et les comparaisons utiles en Algérie`,
      features: [
        `Consultez les horaires de prière à ${cityName} aujourd'hui avec Fajr, Dhuhr, Asr, Maghrib, Isha et le compte à rebours jusqu'à la prochaine prière.`,
        "Le statut de la prière en cours, la date du jour et la méthode de calcul restent visibles sur la même page pour une vérification plus rapide.",
        `Depuis ${cityName}, vous pouvez passer directement vers Constantine, Blida, Bejaia, Batna ou Alger sans quitter le cluster Algérie.`,
        "La page couvre aussi des formulations de recherche réelles comme horaire priere, heures de prière, adhan, maghreb et icha dans une seule URL canonique."
      ],
      aboutParagraphs: [
        `Cette page est conçue pour la recherche directe : horaires de prière à ${cityName} aujourd'hui, avec le planning complet visible immédiatement.`,
        "Le tableau du jour, le compte à rebours et la méthode affichée restent ensemble pour que la réponse soit plus rapide à vérifier.",
        ...
        "Le bloc des autres villes permet aussi de comparer Sétif avec Constantine, Blida, Bejaia, Batna ou Alger sans sortir de la couche prioritaire Algérie.",
        "Pour Sétif, la couverture vise les recherches de ville complète et les formulations mixtes autour de adhan, maghreb et horaires de prière."
      ],
      faq: [
        {
          question: `Cette page ${cityName} affiche-t-elle les cinq prières du jour ?`,
        ...
        {
          question: `Puis-je comparer rapidement ${cityName} avec d'autres villes d'Algérie ?`,
          answer: "Oui. Les liens de ville vous mènent directement vers Constantine, Blida, Bejaia, Batna et Alger pour comparer les horaires."
        },
        {
          question: `Puis-je utiliser cette page si je cherche les horaires d'une mosquée à ${cityName} ?`,
          answer: "Oui. La page de Sétif sert de référence canonique pour la ville, puis vous pouvez vérifier l'écart éventuel avec votre mosquée ou votre quartier."
        },
        {
          question: `Les horaires de prière à ${cityName} peuvent-ils varier selon la source ?`,
          answer: "Oui. Les horaires peuvent varier selon la méthode de calcul ou la référence locale, donc comparez aussi avec votre mosquée si nécessaire."
    ...
    blida: {
      infoTitle: `Horaires de prière à ${cityName} avec le planning complet et les autres villes clés d'Algérie`,
      features: [
        `Consultez les horaires de prière à ${cityName} aujourd'hui avec Fajr, Dhuhr, Asr, Maghrib, Isha et le compte à rebours jusqu'à la prochaine prière.`,
        "Le statut de la prière en cours, la date du jour et la méthode de calcul restent visibles sur la même page pour une vérification plus rapide.",
        `Depuis ${cityName}, vous pouvez comparer directement Alger, Constantine, Sétif, Tlemcen ou Sidi Bel Abbes sans quitter le bloc Algérie.`,
        "La page couvre aussi les formulations locales comme horaire priere, horaires de prière, adhan, dohr et maghreb sans multiplier les pages synonymes."
      ],
      aboutParagraphs: [
        `Cette page est conçue pour la recherche directe : horaires de prière à ${cityName} aujourd'hui, avec le planning complet visible immédiatement.`,
        "Le tableau du jour, le compte à rebours et la méthode affichée restent ensemble pour que la réponse soit plus rapide à vérifier.",
        `Si vous comparez avec une mosquée locale ou un autre site, utilisez cette page comme point d'entrée rapide puis confrontez la méthode visible à l'autorité locale que vous suivez.`,
        `Si votre recherche mentionne une mosquée à ${cityName}, utilisez d'abord cette page de ville comme référence puis comparez avec les horaires de ce lieu de prière.`,
        "Le bloc des autres villes vous laisse comparer Blida avec Alger, Constantine, Sétif, Tlemcen ou Sidi Bel Abbes dans le même contexte algérien.",
        "Pour Blida, la couverture vise les recherches de ville complète et les variantes autour de adhan, maghreb et horaires de prière."
      ],
      faq: [
        {
          question: `Cette page ${cityName} affiche-t-elle les cinq prières du jour ?`,
        ...
        {
          question: `Puis-je comparer rapidement ${cityName} avec d'autres villes d'Algérie ?`,
          answer: "Oui. Les autres villes vous donnent un accès direct à Alger, Constantine, Sétif, Tlemcen et Sidi Bel Abbes pour comparer rapidement les horaires."
        },
        {
          question: `Puis-je utiliser cette page si je cherche les horaires d'une mosquée à ${cityName} ?`,
          answer: "Oui. Cette page de Blida donne une base claire pour la ville entière, puis vous pouvez la rapprocher des horaires de votre mosquée ou de votre secteur local."
        },
        {
          question: `Les horaires de prière à ${cityName} peuvent-ils varier selon la source ?`,
          answer: "Oui. Les horaires peuvent varier selon la méthode de calcul ou la référence locale, donc comparez aussi avec votre mosquée si nécessaire."
...
function buildFrenchPriorityIntentCopy(pageType) {
  ...
  if (pageType === "next-prayer") {
    return {
      metaTitle: "Prochaine prière aujourd'hui | Compte à rebours en direct | Adantimer",
      metaDescription: "Suivez la prochaine prière aujourd'hui avec un compte à rebours en direct, le statut de la prière en cours et des pages de ville ciblées pour Oran, Annaba, Bouira et Ain Benian.",
      heroSubtitle: "Suivez la prochaine prière aujourd'hui avec un compte à rebours en direct et utilisez une seule page canonique pour couvrir des recherches comme prochaine prière, adhan aujourd'hui ou heure de la prochaine prière.",
      infoTitle: "Une page canonique pour les recherches françaises sur la prochaine prière",
      features: [
        "Cette route couvre des formulations centrales comme prochaine prière, heure de la prochaine prière, adhan aujourd'hui et compte à rebours jusqu'à la salat suivante.",
        "Le statut de la prière en cours, la prochaine prière et le planning complet restent visibles sur un seul écran.",
        "La page renvoie ensuite vers des villes déjà porteuses de signaux comme Oran, Annaba, Bouira et Ain Benian au lieu de créer des doublons faibles.",
        "Les variantes adhan, prochaine salat ou prochaine prière sont absorbées par une seule structure propre et partageable."
      ],
      aboutTitle: "Comment utiliser la page française de la prochaine prière",
      aboutParagraphs: [
      ...
      faq: [
        {
          question: "Cette page couvre-t-elle aussi des recherches comme adhan aujourd'hui ?",
          answer: "Oui. Elle a été renforcée pour couvrir naturellement ces formulations tout en gardant une seule URL canonique pour éviter les doublons."
        },
        {
  ...
  if (pageType === "fajr") {
    return {
      metaTitle: "Heure du Fajr aujourd'hui | Recherche quotidienne du Fajr | Adantimer",
      metaDescription: "Vérifiez l'heure du Fajr aujourd'hui, gardez le compte à rebours jusqu'à la prochaine prière visible et accédez directement à Oran, Annaba, Bouira et Ain Benian.",
      heroSubtitle: "Vérifiez l'heure du Fajr aujourd'hui et utilisez une seule page canonique pour couvrir des recherches comme heure du fajr, fajr aujourd'hui ou adhan fajr.",
      infoTitle: "Une page canonique pour les recherches françaises sur l'heure du Fajr",
      features: [
        "Cette route couvre des formulations centrales comme heure du fajr, fajr aujourd'hui, heure du fajr aujourd'hui et adhan fajr.",
        "L'heure du Fajr, la prochaine prière et le planning complet restent visibles sur un seul écran.",
        "La page renvoie ensuite vers des villes déjà porteuses de signaux comme Oran, Annaba, Bouira et Ain Benian au lieu de créer des doublons faibles.",
        "Les variantes heure du fajr ou fajr aujourd'hui sont absorbées par une seule structure propre et partageable."
      ],
      aboutTitle: "Comment utiliser la page française de l'heure du Fajr",
      aboutParagraphs: [
        "Cette page existe pour répondre à l'intention directe: quelle est l'heure du Fajr aujourd'hui et comment la vérifier rapidement.",
        "Au lieu de multiplier les routes synonymes autour du Fajr, Adantimer concentre ces formulations sur une route canonique plus claire.",
        "Quand la requête devient locale, la page transfère ensuite vers les routes de ville les plus pertinentes, en particulier les pages francophones déjà testées dans Google."
      ],
      faqTitle: "Questions fréquentes sur l'heure du Fajr en français",
      faq: [
        {
          question: "Cette page couvre-t-elle aussi des recherches comme heure du fajr aujourd'hui ?",
          answer: "Oui. Elle a été renforcée pour couvrir naturellement ces formulations tout en gardant une seule URL canonique pour éviter les doublons."
        },
        {
          question: "Cette page affiche-t-elle seulement le Fajr ?",
          answer: "Non. Le Fajr est le focus principal, mais le planning complet du jour reste visible sur la même page."
        },
        {
          question: "Puis-je passer de cette page générale à une ville précise ?",
          answer: "Oui. La page relie directement des villes prioritaires comme Oran, Annaba, Bouira et Ain Benian pour les recherches locales les plus proches de vos requêtes."
  ...
  if (pageType === "maghrib") {
    return {
      metaTitle: "Heure du Maghrib aujourd'hui | Recherche quotidienne du Maghrib | Adantimer",
      metaDescription: "Vérifiez l'heure du Maghrib aujourd'hui, gardez le compte à rebours jusqu'à la prochaine prière visible et accédez directement à Oran, Annaba, Bouira et Ain Benian.",
      heroSubtitle: "Vérifiez l'heure du Maghrib aujourd'hui et utilisez une seule page canonique pour couvrir des recherches comme adhan maghreb, maghrib aujourd'hui ou heure du maghrib.",
      infoTitle: "Une page canonique pour les recherches françaises sur l'heure du Maghrib",
      features: [
        "Cette route couvre des formulations centrales comme heure du maghrib, adhan maghreb, maghrib aujourd'hui, maghreb et heure du coucher de la prière du soir.",
        "L'heure du Maghrib, la prochaine prière et le planning complet restent visibles sur un seul écran.",
        "La page renvoie ensuite vers des villes déjà porteuses de signaux comme Oran, Annaba, Bouira et Ain Benian au lieu de créer des doublons faibles.",
        "Les variantes maghreb ou maghrib sont absorbées par une seule structure propre et partageable."
      ],
      aboutTitle: "Comment utiliser la page française de l'heure du Maghrib",
      aboutParagraphs: [
        "Cette page existe pour répondre à l'intention directe: quelle est l'heure du Maghrib aujourd'hui et comment la vérifier rapidement.",
        "Au lieu de multiplier les routes synonymes autour d'adhan maghreb ou de maghrib aujourd'hui, Adantimer concentre ces formulations sur une route canonique plus claire.",
        "Quand la requête devient locale, la page transfère ensuite vers les routes de ville les plus pertinentes, en particulier les pages francophones déjà testées dans Google."
      ],
      faqTitle: "Questions fréquentes sur l'heure du Maghrib en français",
      faq: [
        {
          question: "Cette page couvre-t-elle aussi des recherches comme adhan maghreb ?",
          answer: "Oui. Elle a été renforcée pour couvrir naturellement ces formulations tout en gardant une seule URL canonique pour éviter les doublons."
        },
        {
          question: "Pourquoi voit-on parfois maghreb et parfois maghrib ?",
          answer: "Les usages et translittérations varient selon les pays et les habitudes. Adantimer couvre ces variantes dans le contenu sans créer une page différente pour chaque orthographe."
        },
        {
          question: "Puis-je passer de cette page générale à une ville précise ?",
          answer: "Oui. La page relie directement des villes prioritaires comme Oran, Annaba, Bouira et Ain Benian pour les recherches locales les plus proches de vos requêtes."
  ...
  if (pageType === "isha") {
    return {
      metaTitle: "Heure de l'Isha aujourd'hui | Recherche quotidienne de l'Isha | Adantimer",
      metaDescription: "Vérifiez l'heure de l'Isha aujourd'hui, gardez le compte à rebours jusqu'à la prochaine prière visible et accédez directement à Oran, Annaba, Bouira et Ain Benian.",
      heroSubtitle: "Vérifiez l'heure de l'Isha aujourd'hui et utilisez une seule page canonique pour couvrir des recherches comme icha aujourd'hui, isha aujourd'hui ou heure de l'isha.",
      infoTitle: "Une page canonique pour les recherches françaises sur l'heure de l'Isha",
      features: [
        "Cette route couvre des formulations centrales comme heure de l'isha, icha aujourd'hui, isha aujourd'hui et heure de la prière du soir.",
        "L'heure de l'Isha, la prochaine prière et le planning complet restent visibles sur un seul écran.",
        "La page renvoie ensuite vers des villes déjà porteuses de signaux comme Oran, Annaba, Bouira et Ain Benian au lieu de créer des doublons faibles.",
        "Les variantes icha ou isha sont absorbées par une seule structure propre et partageable."
      ],
      aboutTitle: "Comment utiliser la page française de l'heure de l'Isha",
      aboutParagraphs: [
        "Cette page existe pour répondre à l'intention directe: quelle est l'heure de l'Isha aujourd'hui et comment la vérifier rapidement.",
        "Au lieu de multiplier les routes synonymes autour d'icha aujourd'hui ou d'isha aujourd'hui, Adantimer concentre ces formulations sur une route canonique plus claire.",
        "Quand la requête devient locale, la page transfère ensuite vers les routes de ville les plus pertinentes, en particulier les pages francophones déjà testées dans Google."
      ],
      faqTitle: "Questions fréquentes sur l'heure de l'Isha en français",
      faq: [
        {
          question: "Cette page couvre-t-elle aussi des recherches comme icha aujourd'hui ?",
          answer: "Oui. Elle a été renforcée pour couvrir naturellement ces formulations tout en gardant une seule URL canonique pour éviter les doublons."
        },
        {
          question: "Pourquoi voit-on parfois icha et parfois isha ?",
          answer: "Les usages et translittérations varient selon les pays et les habitudes. Adantimer couvre ces variantes dans le contenu sans créer une page différente pour chaque orthographe."
        },
        {
          question: "Puis-je passer de cette page générale à une ville précise ?",
...
function buildArabicPriorityIntentCityCopy(pageType, cityKey, place) {
  ...
  if (key === "next-prayer:oran") {
    return {
      metaTitle: `الصلاة القادمة في ${place} اليوم | عد تنازلي مباشر للصلاة | Adantimer`,
      metaDescription: `اعرف الصلاة القادمة في ${place} اليوم مع عد تنازلي مباشر، وحالة الصلاة الحالية، وجدول اليوم الكامل في صفحة واحدة.`,
      heroSubtitle: `تابع الصلاة القادمة في ${place} مع عد تنازلي مباشر، وراجع حالة الصلاة الحالية وجدول اليوم الكامل قبل الانتقال إلى أي مسار أضيق.`,
      infoTitle: `استخدم هذه الصفحة عندما تكون الصلاة القادمة في ${place} هي السؤال الأساسي`,
      aboutTitle: `ما الذي يجب أن تجيب عنه صفحة الصلاة القادمة في ${place} أولا`,
      aboutParagraphs: [
        `هذه الصفحة مبنية لنية البحث المباشرة: ما هي الصلاة القادمة في ${place} وكم يبقى على بدايتها.`,
        "تعرض الصفحة العد التنازلي، وحالة الصلاة الحالية، والجدول اليومي الكامل، وطريقة الحساب الظاهرة في مكان واحد.",
        "بعد أول فحص سريع، يمكنك الانتقال من نفس الصفحة إلى مواقيت الصلاة الكاملة أو إلى وقت الفجر داخل المدينة نفسها."
      ],
      faqTitle: `أسئلة شائعة عن الصلاة القادمة في ${place}`,
      faq: [
        {
          question: `هل تعرض هذه الصفحة الصلاة القادمة فقط في ${place}؟`,
          answer: `لا. الصلاة القادمة هي محور الصفحة، لكن جدول اليوم الكامل في ${place} يبقى ظاهرا معها في نفس الشاشة.`
        },
        {
          question: `هل يمكنني الانتقال من صفحة الصلاة القادمة في ${place} إلى مسارات أخرى داخل المدينة؟`,
          answer: `نعم. الصفحة تربطك مباشرة بمواقيت الصلاة الكاملة وبمسارات أدق مثل وقت الفجر داخل ${place}.`
        },
        {
  ...
  if (key === "maghrib:annaba") {
    return {
      metaTitle: `وقت المغرب في ${place} اليوم | دليل وقت المغرب اليومي | Adantimer`,
      metaDescription: `تحقق من وقت المغرب في ${place} اليوم، وراجع الجدول اليومي الكامل، وأبق الصلاة القادمة ظاهرة في نفس الصفحة.`,
      ...
      aboutParagraphs: [
        ...
        "يبقى وقت المغرب مع الجدول اليومي الكامل، والصلاة القادمة، وطريقة الحساب الظاهرة في نفس الشاشة.",
        "عندما تحتاج إلى مراجعة أوسع بعد وقت المغرب، تنقلك الروابط إلى مواقيت الصلاة الكاملة أو إلى مسارات مدنية أدق داخل عنابة."
      ],
      faqTitle: `أسئلة شائعة عن وقت المغرب في ${place}`,
      faq: [
        {
          question: `هل تعرض الصفحة وقت المغرب فقط في ${place}؟`,
          answer: `لا. الصفحة تركز على وقت المغرب في ${place} لكنها تبقي بقية مواقيت اليوم ظاهرة معها في نفس الصفحة.`
        },
        {
          question: `هل أرى الصلاة القادمة مع وقت المغرب في ${place}؟`,
          answer: "نعم. تبقى الصلاة القادمة مرئية مع الجدول الكامل حتى يكون الانتقال بين المواقيت أسرع."
        },
        {
          question: `لماذا قد يختلف وقت المغرب في ${place} عن مصدر آخر؟`,
          answer: "قد تختلف المواقيت بحسب طريقة الحساب أو الجهة المحلية التي تتبعها، لذلك قارن دائما مع المسجد المحلي عند الحاجة."
        }
      ]
    };
  }

  if (key === "maghrib:bouira") {
    return {
      metaTitle: `وقت المغرب في ${place} اليوم | دليل وقت المغرب اليومي | Adantimer`,
      metaDescription: `تحقق من وقت المغرب في ${place} اليوم، وراجع مواقيت الصلاة الكاملة، وأبق الصلاة القادمة ظاهرة في الصفحة نفسها.`,
      heroSubtitle: `تحقق من وقت المغرب في ${place} اليوم، وراجع مواقيت الصلاة الكاملة، وأبق الصلاة القادمة ظاهرة لتأكيد التوقيت بسرعة.`,
      infoTitle: `استخدم هذه الصفحة عندما يكون وقت المغرب في ${place} هو السؤال الأساسي`,
      aboutTitle: `ما الذي يجب أن تجيب عنه صفحة وقت المغرب في ${place} أولا`,
      aboutParagraphs: [
        `هذه الصفحة مبنية للسؤال المباشر: ما وقت المغرب في ${place} اليوم وكيف أتحقق منه بسرعة.`,
        "تعرض الصفحة وقت المغرب مع مواقيت الصلاة الكاملة، والصلاة القادمة، وطريقة الحساب الظاهرة في نفس المكان.",
        "بعد التحقق من وقت المغرب، يمكنك الانتقال من نفس الصفحة إلى مواقيت الصلاة الكاملة أو إلى مسارات أخرى أدق داخل البويرة."
      ],
      faqTitle: `أسئلة شائعة عن وقت المغرب في ${place}`,
      faq: [
        {
          question: `هل تعرض هذه الصفحة وقت المغرب مع بقية المواقيت في ${place}؟`,
          answer: `نعم. وقت المغرب هو محور الصفحة، لكن بقية مواقيت الصلاة في ${place} تبقى ظاهرة معه في نفس الشاشة.`
        },
        {
          question: `هل أرى الصلاة القادمة مع وقت المغرب في ${place}؟`,
          answer: "نعم. تبقى الصلاة القادمة والجدول الكامل متاحين في الصفحة نفسها لتقليل الحاجة إلى التنقل."
        },
        {
          question: `لماذا قد يختلف وقت المغرب في ${place} عن مصدر آخر؟`,
  ...
  if (key === "isha:ain-benian") {
    return {
      metaTitle: `وقت العشاء في ${place} اليوم | دليل وقت العشاء اليومي | Adantimer`,
      metaDescription: `تحقق من وقت العشاء في ${place} اليوم، وراجع الجدول اليومي الكامل، وأبق الصلاة القادمة ظاهرة للوصول الأسرع.`,
      heroSubtitle: `تحقق من وقت العشاء في ${place} اليوم، وراجع الجدول اليومي الكامل، وأبق الصلاة القادمة ظاهرة لتأكيد التوقيت بسرعة.`,
      infoTitle: `استخدم هذه الصفحة عندما يكون وقت العشاء في ${place} هو السؤال الأساسي`,
      aboutTitle: `ما الذي يجب أن تجيب عنه صفحة وقت العشاء في ${place} أولا`,
      aboutParagraphs: [
        `هذه الصفحة مبنية للسؤال المباشر: ما وقت العشاء في ${place} اليوم وكيف أتحقق منه بسرعة.`,
        "تعرض الصفحة وقت العشاء مع الجدول اليومي الكامل، والصلاة القادمة، وطريقة الحساب الظاهرة في شاشة واحدة.",
        "بعد أول تحقق، يمكنك الانتقال إلى مواقيت الصلاة الكاملة أو إلى مسارات أدق داخل عين البنيان من نفس الصفحة."
      ],
      faqTitle: `أسئلة شائعة عن وقت العشاء في ${place}`,
      faq: [
        {
          question: `هل تعرض الصفحة وقت العشاء مع بقية المواقيت في ${place}؟`,
          answer: `نعم. وقت العشاء هو محور الصفحة، لكن بقية مواقيت اليوم في ${place} تبقى ظاهرة معه.`
        },
        {
          question: `هل أرى الصلاة القادمة مع وقت العشاء في ${place}؟`,
          answer: "نعم. تبقى الصلاة القادمة مرئية مع الجدول الكامل حتى يكون التحقق أسرع وأسهل."
        },
        {
          question: `لماذا قد يختلف وقت العشاء في ${place} عن مصدر آخر؟`,
          answer: "قد تختلف المواقيت بحسب طريقة الحساب أو الجهة المحلية التي تتبعها، لذلك تبقى طريقة الحساب الظاهرة وإرشاد المسجد المحلي مهمين."
        }
      ]
    };
  }
...
function buildArabicPriorityHomeCityCopy(cityName, variant = "generic") {
  ...
  if (variant === "oran") {
    return {
      metaTitle: "مواقيت الصلاة في وهران اليوم | الفجر والظهر والعصر والمغرب والعشاء | Adantimer",
      metaDescription: "تحقق من مواقيت الصلاة في وهران اليوم مع الفجر والظهر والعصر والمغرب والعشاء والعد التنازلي للصلاة القادمة.",
      heroSubtitle: "تحقق من مواقيت الصلاة في وهران اليوم، وتابع العد التنازلي للصلاة القادمة، وراجع الجدول الكامل في صفحة واحدة.",
      infoTitle: "مواقيت الصلاة في وهران مع الجدول الكامل والصلاة القادمة",
      features: [
        "اعرض جدول وهران اليومي للفجر والظهر والعصر والمغرب والعشاء مع العد التنازلي للصلاة القادمة.",
        "تبقى الصلاة الحالية وتاريخ اليوم وطريقة الحساب الظاهرة في نفس الصفحة لسهولة المراجعة.",
        "تنتقل الصفحة مباشرة من وهران إلى مسارات أكثر تركيزا مثل الصلاة القادمة أو الفجر أو العرض الكامل للمواقيت.",
        "تغطي الصفحة أيضا صيغ البحث الشائعة مثل مواقيت الصلاة ووقت الفجر ووقت المغرب والصلاة القادمة في وهران."
      ],
      aboutTitle: "كيف تستخدم صفحة مواقيت الصلاة في وهران",
      aboutParagraphs: [
      ...
      faq: [
        {
          question: "هل تعرض هذه الصفحة الصلوات الخمس اليومية في وهران؟",
          answer: "نعم. تعرض الصفحة الفجر والظهر والعصر والمغرب والعشاء مع العد التنازلي للصلاة القادمة."
        },
        {
          question: "هل يمكنني معرفة الصلاة القادمة في وهران من نفس الصفحة؟",
          answer: "نعم. تبقى الصلاة القادمة مرئية مع الجدول الكامل حتى لا تحتاج إلى الانتقال السريع بين صفحات كثيرة."
        },
        {
  ...
  if (variant === "annaba") {
    return {
      metaTitle: "مواقيت الصلاة في عنابة اليوم | الفجر والظهر والعصر والمغرب والعشاء | Adantimer",
      metaDescription: "تحقق من مواقيت الصلاة في عنابة اليوم مع الفجر والظهر والعصر والمغرب والعشاء والعد التنازلي للصلاة القادمة.",
      heroSubtitle: "تحقق من مواقيت الصلاة في عنابة اليوم، وتابع العد التنازلي للصلاة القادمة، وراجع الجدول الكامل في صفحة واحدة.",
      infoTitle: "مواقيت الصلاة في عنابة مع الجدول الكامل والصلاة القادمة",
      features: [
        "اعرض جدول عنابة اليومي للفجر والظهر والعصر والمغرب والعشاء مع العد التنازلي للصلاة القادمة.",
        "تبقى الصلاة الحالية وتاريخ اليوم وطريقة الحساب الظاهرة في نفس الصفحة لسهولة المراجعة.",
        "تنتقل الصفحة مباشرة من عنابة إلى مسارات أكثر تركيزا مثل الصلاة القادمة أو الفجر أو العرض الكامل للمواقيت.",
        "تغطي الصفحة صيغ البحث الشائعة مثل وقت المغرب والصلاة القادمة ومواقيت الصلاة في عنابة."
      ],
      aboutTitle: "كيف تستخدم صفحة مواقيت الصلاة في عنابة",
      aboutParagraphs: [
      ...
      faq: [
        {
          question: "هل تعرض هذه الصفحة الصلوات الخمس اليومية في عنابة؟",
          answer: "نعم. تعرض الصفحة الفجر والظهر والعصر والمغرب والعشاء مع العد التنازلي للصلاة القادمة."
        },
        {
          question: "هل يمكنني معرفة وقت المغرب في عنابة من نفس الصفحة؟",
          answer: "نعم. تبقى مواقيت اليوم كلها ظاهرة، بما فيها المغرب والصلاة القادمة، في نفس الصفحة."
        },
        {
  ...
  if (variant === "bouira") {
    return {
      metaTitle: "مواقيت الصلاة في البويرة اليوم | الفجر والظهر والعصر والمغرب والعشاء | Adantimer",
      metaDescription: "تحقق من مواقيت الصلاة في البويرة اليوم مع الفجر والظهر والعصر والمغرب والعشاء والعد التنازلي للصلاة القادمة.",
      heroSubtitle: "تحقق من مواقيت الصلاة في البويرة اليوم، وتابع العد التنازلي للصلاة القادمة، وراجع الجدول الكامل في صفحة واحدة.",
      infoTitle: "مواقيت الصلاة في البويرة مع الجدول الكامل والصلاة القادمة",
      features: [
        "اعرض جدول البويرة اليومي للفجر والظهر والعصر والمغرب والعشاء مع العد التنازلي للصلاة القادمة.",
        "تبقى الصلاة الحالية وتاريخ اليوم وطريقة الحساب الظاهرة في نفس الصفحة لسهولة المراجعة.",
        "تنتقل الصفحة مباشرة من البويرة إلى مسارات أكثر تركيزا مثل الصلاة القادمة أو الفجر أو العرض الكامل للمواقيت.",
        "تغطي الصفحة صيغ البحث الشائعة مثل وقت المغرب ومواقيت الصلاة والصلاة القادمة في البويرة."
      ],
      aboutTitle: "كيف تستخدم صفحة مواقيت الصلاة في البويرة",
      aboutParagraphs: [
      ...
      faq: [
        {
          question: "هل تعرض هذه الصفحة الصلوات الخمس اليومية في البويرة؟",
          answer: "نعم. تعرض الصفحة الفجر والظهر والعصر والمغرب والعشاء مع العد التنازلي للصلاة القادمة."
        },
        {
          question: "هل يمكنني معرفة وقت المغرب أو الصلاة القادمة في البويرة من نفس الصفحة؟",
          answer: "نعم. تبقى مواقيت اليوم كلها ظاهرة مع الصلاة القادمة حتى لا تحتاج إلى الانتقال السريع بين صفحات كثيرة."
        },
        {
  ...
  if (variant === "ain-benian") {
    return {
      metaTitle: "مواقيت الصلاة في عين البنيان اليوم | الفجر والظهر والعصر والمغرب والعشاء | Adantimer",
      metaDescription: "تحقق من مواقيت الصلاة في عين البنيان اليوم مع الفجر والظهر والعصر والمغرب والعشاء والعد التنازلي للصلاة القادمة.",
      heroSubtitle: "تحقق من مواقيت الصلاة في عين البنيان اليوم، وتابع العد التنازلي للصلاة القادمة، وراجع الجدول الكامل في صفحة واحدة.",
      infoTitle: "مواقيت الصلاة في عين البنيان مع الجدول الكامل والصلاة القادمة",
      features: [
        "اعرض جدول عين البنيان اليومي للفجر والظهر والعصر والمغرب والعشاء مع العد التنازلي للصلاة القادمة.",
        "تبقى الصلاة الحالية وتاريخ اليوم وطريقة الحساب الظاهرة في نفس الصفحة لسهولة المراجعة.",
        "تنتقل الصفحة مباشرة من عين البنيان إلى مسارات أكثر تركيزا مثل الصلاة القادمة أو الفجر أو العرض الكامل للمواقيت.",
        "تغطي الصفحة صيغ البحث الشائعة مثل وقت العشاء ومواقيت الصلاة والصلاة القادمة في عين البنيان."
      ],
      aboutTitle: "كيف تستخدم صفحة مواقيت الصلاة في عين البنيان",
      aboutParagraphs: [
      ...
      faq: [
        {
          question: "هل تعرض هذه الصفحة الصلوات الخمس اليومية في عين البنيان؟",
          answer: "نعم. تعرض الصفحة الفجر والظهر والعصر والمغرب والعشاء مع العد التنازلي للصلاة القادمة."
        },
        {
          question: "هل يمكنني معرفة وقت العشاء أو الصلاة القادمة في عين البنيان من نفس الصفحة؟",
          answer: "نعم. تبقى مواقيت اليوم كلها ظاهرة مع الصلاة القادمة حتى لا تحتاج إلى الانتقال السريع بين صفحات كثيرة."
        },
        {
  ...
  if (variant === "constantine") {
    return {
      ...
      features: [
        ...
        `يمكنك الانتقال مباشرة من ${cityName} إلى الجزائر العاصمة أو سطيف أو البليدة أو عنابة أو باتنة للمقارنة داخل نفس طبقة الجزائر.`,
        "تغطي الصفحة أيضًا صيغ البحث الشائعة مثل مواقيت الصلاة ووقت الفجر ووقت المغرب والصلاة القادمة بدون إنشاء صفحات مترادفة ضعيفة."
      ],
      aboutTitle: `كيف تستخدم صفحة مواقيت الصلاة في ${cityName}`,
      aboutParagraphs: [
        ...
        `إذا كان بحثك يتضمن اسم مسجد محدد في ${cityName}، فابدأ بهذه الصفحة كمرجع أولي للمدينة ثم قارنها بجدول ذلك المسجد المحلي.`,
        "ويساعدك قسم المدن الأخرى أيضًا على مقارنة قسنطينة مع الجزائر العاصمة وسطيف والبليدة وعنابة أو باتنة داخل نفس السوق الجزائري."
      ],
      faqTitle: `أسئلة شائعة عن مواقيت الصلاة في ${cityName}`,
      faq: [
        {
        ...
        {
          question: `هل أستطيع مقارنة ${cityName} مع مدن جزائرية أخرى من نفس الصفحة؟`,
          answer: "نعم. قسم المدن الأخرى يوصلك مباشرة إلى الجزائر العاصمة وسطيف والبليدة وعنابة وباتنة حتى تقارن المواقيت بسرعة."
        },
        {
          question: `هل يمكنني استخدام هذه الصفحة إذا كنت أبحث عن مواقيت مسجد في ${cityName}؟`,
          answer: "نعم. هذه الصفحة تعطيك مرجعًا سريعًا لقسنطينة، ثم يمكنك مقارنة الجدول الظاهر فيها بجدول المسجد أو الحي الذي تتبعه."
        },
        {
          question: `لماذا قد تختلف مواقيت الصلاة في ${cityName} عن مصدر آخر؟`,
          answer: "قد تختلف المواقيت بحسب طريقة الحساب أو الجدول المحلي، لذلك تبقى طريقة الحساب الظاهرة وإرشاد المسجد المحلي مهمين."
  ...
  if (variant === "setif") {
    return {
      ...
      metaDescription: `تحقق من مواقيت الصلاة في ${cityName} اليوم مع الفجر والظهر والعصر والمغرب والعشاء والعد التنازلي للصلاة القادمة.`,
      heroSubtitle: `تحقق من مواقيت الصلاة في ${cityName} اليوم، وتابع الصلاة القادمة، وراجع الجدول الكامل في صفحة واحدة.`,
      infoTitle: `مواقيت الصلاة في ${cityName} مع الجدول الكامل والمدن الجزائرية القريبة`,
      features: [
        `اعرض جدول ${cityName} اليومي للفجر والظهر والعصر والمغرب والعشاء مع العد التنازلي للصلاة القادمة.`,
        "تبقى الصلاة الحالية وتاريخ اليوم وطريقة الحساب الظاهرة في نفس الصفحة لسهولة المراجعة السريعة.",
        `يمكنك الانتقال مباشرة من ${cityName} إلى قسنطينة أو البليدة أو بجاية أو باتنة أو الجزائر العاصمة للمقارنة داخل كتلة الجزائر.`,
        "تغطي الصفحة أيضًا نية البحث المحلية حول مواقيت الصلاة ووقت المغرب والصلاة القادمة في سطيف ضمن رابط واحد واضح."
      ],
      aboutTitle: `كيف تستخدم صفحة مواقيت الصلاة في ${cityName}`,
      aboutParagraphs: [
        `هذه الصفحة مبنية لمن يبحث مباشرة عن مواقيت الصلاة في ${cityName} اليوم مع ظهور الجدول الكامل والعد التنازلي من أول نظرة.`,
        ...
        "وقسم المدن الأخرى يتيح لك مقارنة سطيف مع قسنطينة والبليدة وبجاية وباتنة أو الجزائر العاصمة ضمن نفس تركيز الجزائر."
      ],
      faqTitle: `أسئلة شائعة عن مواقيت الصلاة في ${cityName}`,
      faq: [
        {
        ...
        {
          question: `هل أستطيع مقارنة ${cityName} مع مدن جزائرية أخرى من نفس الصفحة؟`,
          answer: "نعم. روابط المدن الأخرى تنقلك مباشرة إلى قسنطينة والبليدة وبجاية وباتنة والجزائر العاصمة لمقارنة المواقيت."
        },
        {
          question: `هل يمكنني استخدام هذه الصفحة إذا كنت أبحث عن مواقيت مسجد في ${cityName}؟`,
          answer: "نعم. صفحة سطيف تعطيك مرجعًا واضحًا للمدينة، ثم يمكنك مقارنة الجدول المعروض بجدول المسجد أو الحي الذي تتبعه."
        },
        {
          question: `لماذا قد تختلف مواقيت الصلاة في ${cityName} عن مصدر آخر؟`,
          answer: "قد تختلف المواقيت بحسب طريقة الحساب أو الجدول المحلي، لذلك تبقى طريقة الحساب الظاهرة وإرشاد المسجد المحلي مهمين."
  ...
  if (variant === "blida") {
    return {
      ...
      metaDescription: `تحقق من مواقيت الصلاة في ${cityName} اليوم مع الفجر والظهر والعصر والمغرب والعشاء والعد التنازلي للصلاة القادمة.`,
      heroSubtitle: `تحقق من مواقيت الصلاة في ${cityName} اليوم، وتابع الصلاة القادمة، وراجع الجدول الكامل في صفحة واحدة.`,
      infoTitle: `مواقيت الصلاة في ${cityName} مع الجدول الكامل ومقارنة المدن المهمة في الجزائر`,
      features: [
        `اعرض جدول ${cityName} اليومي للفجر والظهر والعصر والمغرب والعشاء مع العد التنازلي للصلاة القادمة.`,
        "تبقى الصلاة الحالية وتاريخ اليوم وطريقة الحساب الظاهرة في نفس الصفحة لسهولة المراجعة السريعة.",
        `يمكنك الانتقال مباشرة من ${cityName} إلى الجزائر العاصمة أو قسنطينة أو سطيف أو تلمسان أو سيدي بلعباس للمقارنة داخل نفس طبقة الجزائر.`,
        "تغطي الصفحة أيضًا صيغ البحث المتداولة حول مواقيت الصلاة ووقت المغرب ووقت الفجر والصلاة القادمة بدون تفتيت النية على صفحات كثيرة."
      ],
      aboutTitle: `كيف تستخدم صفحة مواقيت الصلاة في ${cityName}`,
      aboutParagraphs: [
        `هذه الصفحة مبنية لمن يبحث مباشرة عن مواقيت الصلاة في ${cityName} اليوم مع ظهور الجدول الكامل والعد التنازلي من أول نظرة.`,
        ...
        "كما يتيح لك قسم المدن الأخرى مقارنة البليدة مع الجزائر العاصمة وقسنطينة وسطيف وتلمسان أو سيدي بلعباس داخل نفس التركيز الجزائري."
      ],
      faqTitle: `أسئلة شائعة عن مواقيت الصلاة في ${cityName}`,
      faq: [
        {
        ...
        {
          question: `هل أستطيع مقارنة ${cityName} مع مدن جزائرية أخرى من نفس الصفحة؟`,
          answer: "نعم. قسم المدن الأخرى يوصلك مباشرة إلى الجزائر العاصمة وقسنطينة وسطيف وتلمسان وسيدي بلعباس لمقارنة المواقيت بسرعة."
        },
        {
          question: `هل يمكنني استخدام هذه الصفحة إذا كنت أبحث عن مواقيت مسجد في ${cityName}؟`,
          answer: "نعم. صفحة البليدة تعطيك أساسًا واضحًا للمدينة، ثم يمكنك مقارنتها بجدول المسجد أو الجهة المحلية التي تتبعها."
        },
        {
          question: `لماذا قد تختلف مواقيت الصلاة في ${cityName} عن مصدر آخر؟`,
          answer: "قد تختلف المواقيت بحسب طريقة الحساب أو الجدول المحلي، لذلك تبقى طريقة الحساب الظاهرة وإرشاد المسجد المحلي مهمين."
...
function applyAlgeriaKeywordCoverageEnhancements(language, pageType, cityKey, place, copy) {
  ...
  if (language === "ar") {
    ...
    about.push(queryLine);
    about.push(`وتبقى مفيدة أيضا لبحوث محلية مثل مسجد ${place} واذان ${place} وصلاة ${place} ووقت الصلاة ${place} و${pageType === "home" ? `الصلاة القادمة ${place}` : `${copy.heroHeadingHome || "مواقيت الصلاة"} ${place}`} بدون فتح مسارات ضعيفة كثيرة.`);
    faq.push({
